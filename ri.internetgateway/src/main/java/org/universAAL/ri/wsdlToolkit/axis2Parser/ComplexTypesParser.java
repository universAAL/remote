...
public class ComplexTypesParser {
    ...
    public static void parseComplexType(AxisService service, XmlSchemaElement schElemOfType, XmlSchemaType xmlSchemaOfType, ComplexObject co,
                    ...
                    if (schElemOfType != null) {
                        if (schElemOfType.getQName() != null) {
                            ...
                            if (schElemOfType.getMaxOccurs() > 1&&!co.isIsArrayType()) {
                                ...
                                co3.setObjectName(new QName(co.getObjectType().getNamespaceURI(), co.getObjectType().getLocalPart().replace("[]", ""), co.getObjectType().getPrefix()));
                                co3.setObjectType(new QName(co.getObjectType().getNamespaceURI(), co.getObjectType().getLocalPart().replace("[]", ""), co.getObjectType().getPrefix()));
                                co3.setHasParent(co);
                                ...
                                co.setObjectType(new QName(co.getObjectType().getNamespaceURI(), co.getObjectType().getLocalPart() + "[]", co.getObjectType().getPrefix()));
                                }
                                else{
                                    co.setObjectType(new QName(co.getObjectType().getNamespaceURI(), co.getObjectType().getLocalPart() , co.getObjectType().getPrefix()));
                                }
        ...
        if (schElemOfType != null) {
            ...
            System.out.println("\t\t\t\t### COMPLEX TYPE " + schElemOfType.getName() + "  [" + schElemOfType.getSchemaTypeName() + "]      PARSING...");
            ...
            try {
                ...
                //To object name se ayti tin periptwsi exei ginei set apo prin apo tin klisi tis synartisis
        ...
        if (schElemOfType != null && schElemOfType.getMaxOccurs() > 1) {
            ...
            if (ct.getQName() != null) {
                ...
                //theDefinition.containingErrors.add("WARNING @ line ~1118... ArrayType was null!");
            }

            co.setIsArrayType(true);
            AdditionalTypesParser.parseArrayType(service, co, schElemOfType.getSchemaTypeName(), theDefinition, schElemOfType.getSchemaType(), calledFromAbstractTypeParser);
        ...
        if (sequenceOfComplexType == null) {
            ...
            //Check ti ginetai se MIZAR gia "### COMPLEX TYPE address      PARSING..."
            ...
            if (choiceOfComplexType != null) {
                ...
                AdditionalTypesParser.parseXMLSchemaChoiceElement(service, choiceOfComplexType, co1,
                ...
                if (ct.getContentModel() != null) {
                    if (ct.getContentModel().getClass().getName().contains("XmlSchemaComplexContent")) {
                        try {
                            ...
                            parseComplexContent(service, complexContent, co, theDefinition, calledFromAbstractTypeParser, ct.getQName());
                        ...
                        theDefinition.getContainingErrors().add("ERROR 1 @ Axis2Parser.java @ LINE ~805!!! ...8-12-08 change");
                        //System.exit(-1);
                    }
                    ...
                    if (ct.isAbstract()) {
                        ...
                        if (attsCol != null) {
                            ...
                            System.out.println("WSDL Warning... Complex Type " + ct.getName() + " is not well defined!  ...@Axis2Parser.java @ LINE ~1643");
                            theDefinition.getContainingErrors().add("WSDL Warning... Complex Type " + ct.getName() + " is not well defined!  ...@Axis2Parser.java @ LINE ~812");
                        }
                    }
                }
        ...
        if (!calledFromAbstractTypeParser) {
            ...
            //kane parse ola ta types pou kanoun extend to AbstractType kai valta sti lista.
            if (ct.isAbstract()) {
                co.setIsAbstract(true);
                System.out.println(ct.getQName().toString());
                AdditionalTypesParser.parseAllExtensionTypesOfTheAbstractType(service, co, ct.getQName(), theDefinition);
                System.out.println(ct.getClass().getName());
            }
        }

        //EDW MPAINEI AN DEN YPARXEI ComplexContent kai einai apla ena ComplexType
...
//                        if (newSimpleOrComplexObjectElement.getMaxOccurs() > 1 && !co.isIsArrayType()) {
//                            co1.setIsArrayType(true);
//                            if (!co1.getObjectType().getLocalPart().contains("[]")) {
//                                co1.setObjectType(new QName(co1.getObjectType().getNamespaceURI(), co1.getObjectType().getLocalPart() + "[]", co1.getObjectType().getPrefix()));
//                            }
//                            if (co1.getHasComplexObjects().size() != 0 && !((ComplexObject) co1.getHasComplexObjects().get(0)).getObjectName().getLocalPart().equals(co1.getObjectName().getLocalPart())) {
//                                ComplexObject co3 = new ComplexObject();
//                                co3.setObjectName(new QName(co1.getObjectType().getNamespaceURI(), co1.getObjectType().getLocalPart().replace("[]", ""), co1.getObjectType().getPrefix()));
//                                co3.setObjectType(new QName(co1.getObjectType().getNamespaceURI(), co1.getObjectType().getLocalPart().replace("[]", ""), co1.getObjectType().getPrefix()));
...
//                        }
                    ...
                    try {
                        if (newObj1.getClass().getName().contains("org.apache.ws.commons.schema.XmlSchemaChoice")) {
                            org.apache.ws.commons.schema.XmlSchemaChoice newSimpleOrComplexObjectElement =
                                    (org.apache.ws.commons.schema.XmlSchemaChoice) newObj1;
                                        ...
                                        if (objectXMLSchemaElement.getSchemaType() != null) {
                                            ...
                                            if (objectXMLSchemaElement.getSchemaType().getClass().toString().contains("org.apache.ws.commons.schema.XmlSchemaSimpleType")) {
                                                ...
                                                ComplexObject unionCO =
                                                        SimpleTypesParser.parseSimpleType(objectXMLSchemaElement, null, no1, theDefinition, service);
                                                if (unionCO != null) {
    ...
    public static void parseComplexContent(AxisService service, XmlSchemaComplexContent complexContent, ComplexObject co,
            ParsedWSDLDefinition theDefinition, boolean calledFromAbstractTypeParser, QName typeName) {
        ...
        try {
            if (complexContent.getContent() != null &&
                    complexContent.getContent().getClass().toString().contains("org.apache.ws.commons.schema.XmlSchemaComplexContentExtension")) {
                ...
                if (xmlSchemaType != null) {
                    ...
                    //EDW MPAiNEI AN DEN VREI TO BASETYPE STA ELEMENTS KAI SCHEMATYPES
                ...
                if (extension.getParticle() != null && extension.getParticle().getClass().getName().contains("XmlSchemaChoice")) {
                    System.out.println();
                    ...
                    org.apache.ws.commons.schema.XmlSchemaSequence ctSequence = (XmlSchemaSequence) extension.getParticle();
                            ...
                            if (obj1.getClass().getName().contains("XmlSchemaElement")) {
                                ...
                                if (objectXMLSchemaElement.getSchemaType() != null) {
                                    ...
                                    if (objectXMLSchemaElement.getSchemaType().getClass().toString().contains("org.apache.ws.commons.schema.XmlSchemaSimpleType")) {
                                        ...
                                        if (co1.getHasNativeObjects().size() != 0 && ((NativeObject) co1.getHasNativeObjects().get(0)).getObjectName().getLocalPart().equals("value")) {
                                            NativeObject no = new NativeObject();
                                            no.setObjectName(co1.getObjectName());
                                            no.setObjectType(((NativeObject) co1.getHasNativeObjects().get(0)).getObjectType());
                                    ...
                                    System.out.println(objectXMLSchemaElement.getName());
                                    if (objectXMLSchemaElement.getSchemaTypeName() != null || objectXMLSchemaElement.getRefName() != null) {
                                        org.apache.ws.commons.schema.XmlSchemaType xmlSchemaType1 = null;
                                        xmlSchemaType1 = ParsingUtils.parseWSDLschemasInOrderToFindTheSpecificXMLSchemaType(service, objectXMLSchemaElement.getSchemaTypeName());

                                        if (xmlSchemaType1 == null) {
                                            xmlSchemaType1 = ParsingUtils.parseWSDLschemasInOrderToFindTheSpecificXMLSchemaElement(service, objectXMLSchemaElement.getRefName());
                                        }

                                        if (xmlSchemaType1 == null) {
                                            xmlSchemaType1 = ParsingUtils.parseWSDLschemasInOrderToFindTheSpecificXMLSchemaType(service, objectXMLSchemaElement.getRefName());
                                        ...
                                        if (xmlSchemaType1 == null) {
                                            ...
                                            if (xmlSchemaType1.getClass().getName().contains("org.apache.ws.commons.schema.XmlSchemaSimpleType")) {
                                            ...
                                            } else if (xmlSchemaType1.getClass().getName().contains("org.apache.ws.commons.schema.XmlSchemaComplexType")) {
                                                ComplexObject co1 = new ComplexObject();
                                                if (objectXMLSchemaElement.getQName() != null) {
                                                ...
                                                parseComplexType(service, null, xmlSchemaType1, co1, theDefinition, calledFromAbstractTypeParser);
                                                co.getHasComplexObjects().add(co1);
                                                System.out.println();
                                            } else {
                                                System.out.println();
                    ...
                    //EDW GET ATTRIBUTES DEFINED mesa sto complexContent (sto objectXMLSchemaElement)
                    //Parse Attributes...????????????
                    if (extension != null) {
            ...
            } else if (complexContent.getContent() != null &&
                    complexContent.getContent().getClass().toString().contains("org.apache.ws.commons.schema.XmlSchemaComplexContentRestriction")) {
                org.apache.ws.commons.schema.XmlSchemaComplexContentRestriction restriction =
                        (org.apache.ws.commons.schema.XmlSchemaComplexContentRestriction) complexContent.getContent();
                if (restriction != null) {
                    //Parse ta objects tou co
                    if (restriction.getParticle() != null && restriction.getParticle().getClass().getName().contains("XmlSchemaChoice")) {
                        System.out.println();

...
public class GatewayPortTestImpl extends GatewayPort {
	...
	LogUtils.logInfo(Activator.getModuleContext(), this.getClass(),
		"doPost",
		new Object[] { "Received mocked HTTP Servlet Request " + req },
		null);
	...
	;
	userAndPass[0] = req.getHeader("Authorization").substring(0,
		userAndPassWhole.indexOf(":"));
	userAndPass[1] = req.getHeader("Authorization").substring(
		userAndPassWhole.indexOf(":") + 1);

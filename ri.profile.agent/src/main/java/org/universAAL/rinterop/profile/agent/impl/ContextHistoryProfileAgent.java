 ...
 * {@link org.universAAL.ProfileCHEProvider.ProfileCHEProvider.treat.logger.ProfileLogger} by using the context history.
 * 
 * @author
 */
public class ContextHistoryProfileAgent implements ProfileCHEProvider {
  ...
  public ContextHistoryProfileAgent(ModuleContext context) {
    ...
    cep.addRestriction(MergedRestriction.getFixedValueRestriction(ContextEvent.PROP_RDF_SUBJECT, new Resource(DUMMYUSER)));
    cep.addRestriction(MergedRestriction.getFixedValueRestriction(ContextEvent.PROP_RDF_PREDICATE, new Resource(HAS_LOCATION)));
  ...
  public DeployManager getDeployManager() {
    LogUtils.logDebug(context, ContextHistoryProfileAgent.class, "contextHistoryProfileAgent", new Object[] {"Fetching the DeployManager..."}, null);
    if (deployManager == null) {
      Object ref = context.getContainer().fetchSharedObject(context, new Object[] {DeployManager.class.getName().toString()});
      if (ref != null) {
        LogUtils.logDebug(context, ContextHistoryProfileAgent.class, "contextHistoryProfileAgent", new Object[] {"DeployManager found!"}, null);
        deployManager = (DeployManager)ref;
        LogUtils.logDebug(context, ContextHistoryProfileAgent.class, "contextHistoryProfileAgent", new Object[] {"DeployManager fetched"}, null);
        return deployManager;
      } else {
        LogUtils.logWarn(context, ContextHistoryProfileAgent.class, "contextHistoryProfileAgent", new Object[] {"No DeployManager found"}, null);
        return null;
      }
    } else
      return deployManager;
  ...
  public OnlineStoreManager getOnlineStoreManagerClient() {
    LogUtils
        .logDebug(context, ContextHistoryProfileAgent.class, "contextHistoryProfileAgent", new Object[] {"Fetching the OnlineStoreManager client..."}, null);
    if (storeManager == null) {
      Object ref = context.getContainer().fetchSharedObject(context, new Object[] {OnlineStoreManager.class.getName().toString()});
      if (ref != null) {
        LogUtils.logDebug(context, ContextHistoryProfileAgent.class, "contextHistoryProfileAgent", new Object[] {"OnlineStoreManager client found!"}, null);
        storeManager = (OnlineStoreManager)ref;
        LogUtils.logDebug(context, ContextHistoryProfileAgent.class, "contextHistoryProfileAgent", new Object[] {"OnlineStoreManager client fetched"}, null);
        return storeManager;
      } else {
        LogUtils.logWarn(context, ContextHistoryProfileAgent.class, "contextHistoryProfileAgent", new Object[] {"No OnlineStoreManager client found"}, null);
        return null;
      }
    } else
      return storeManager;

...
public class AdditionalTypesParser {
    ...
    public static ComplexObject parseXmlSchemaGroup_NEW(AxisService service, XmlSchemaGroup group,
    ...
    public static ComplexObject parseXmlSchemaAttributeGroup_NEW(AxisService service, XmlSchemaAttributeGroup group,
            ParsedWSDLDefinition theDefinition){
        System.out.println();
        ComplexObject co=new ComplexObject();
        co.setObjectName(group.getName());
        ...
        while (iter1.hasNext()){
            Object obj1=iter1.next();
            if(obj1.getClass().getName().contains("XmlSchemaAttributeGroupRef")){
                ComplexObject co1=new ComplexObject();
                AdditionalTypesParser.parseXmlSchemaAttributeGroupRefElement(service, (XmlSchemaAttributeGroupRef)obj1, co1, theDefinition);
                if(co1!=null){
                ...
                Object nativeOrComplexObject = AdditionalTypesParser.parseXmlSchemaAttribute((XmlSchemaAttribute)obj1, service, theDefinition);
                if(nativeOrComplexObject.getClass().getName().contains("NativeObject")){
    ...
    public static void parseXmlSchemaGroupRefElement(AxisService service, XmlSchemaGroupRef xsgr, ComplexObject co,
            ParsedWSDLDefinition theDefinition){
        
       ComplexObject co1= ParsingUtils.tryToFindAndParseGroupForSpecificObject(theDefinition, service, xsgr.getRefName());
       if(co1!=null){
            for(int i=0;i<co1.getHasComplexObjects().size();i++){
                co.getHasComplexObjects().add(co1.getHasComplexObjects().get(i));
            }
    ...
    public static void parseXmlSchemaAttributeGroupRefElement(AxisService service, XmlSchemaAttributeGroupRef xsgr, ComplexObject co,
            ParsedWSDLDefinition theDefinition){

       ComplexObject co1= ParsingUtils.tryToFindAndParseAttributeGroupForSpecificObject(theDefinition, service, xsgr.getRefName());
       if(co1!=null){
            for(int i=0;i<co1.getHasComplexObjects().size();i++){
                co.getHasComplexObjects().add(co1.getHasComplexObjects().get(i));
            }
     ...
     public static void parseXmlSchemaElement(AxisService service, Object newObj1, ComplexObject co,
            ParsedWSDLDefinition theDefinition){

         org.apache.ws.commons.schema.XmlSchemaElement newSimpleOrComplexObjectElement=
                    (org.apache.ws.commons.schema.XmlSchemaElement)newObj1;
            ...
            if(newSimpleOrComplexObjectElement.getSchemaType()!=null){
                System.out.println("\t\t\t\t\t\t#"+newSimpleOrComplexObjectElement.getSchemaType().getClass().toString()+"#");

                boolean typeParsed=false;
                if(newSimpleOrComplexObjectElement.getSchemaType().getClass().toString().contains("org.apache.ws.commons.schema.XmlSchemaSimpleType")){
                    NativeObject no1=new NativeObject();
                    ComplexObject unionCO=SimpleTypesParser.parseSimpleType(newSimpleOrComplexObjectElement, null, no1, theDefinition, service);
                    if(unionCO!=null){
                    ...
                    ComplexObject co1=new ComplexObject();
                    ComplexTypesParser.parseComplexType(service, newSimpleOrComplexObjectElement, null, co1, theDefinition, false);
                    typeParsed=true;
                ...
                //GET SCHEMA TYPE NAME if not found, proceed as before...
                    if(newSchemaType.getClass().toString().contains("org.apache.ws.commons.schema.XmlSchemaSimpleType")){
                        ...
                        if(unionCO==null){
                            ...
                            //Panta prin apo ayto ton tropo klisis prepei na exw dwsei prwta to onoma tou co
                            ComplexTypesParser.parseComplexType(service, null, newSchemaType, co1, theDefinition, false);
                                    ...
                                    if(xmlSchemaType!=null){
                                        ...
                                        if(xmlSchemaType.getClass().toString().contains("org.apache.ws.commons.schema.XmlSchemaSimpleType")){
                                            ...
                                            if(unionCO==null){
                                                ...
                                                ComplexTypesParser.parseComplexType(service, null, xmlSchemaType, co1, theDefinition, false);
    ...
    public static void parseXmlSchemaAllType(AxisService service, XmlSchemaAll xsa, ComplexObject co,
            ParsedWSDLDefinition theDefinition){
        ...
        while(iter1.hasNext()){
            ...
            org.apache.ws.commons.schema.XmlSchemaElement newSimpleOrComplexObjectElement=
                    (org.apache.ws.commons.schema.XmlSchemaElement)iter1.next();
            System.out.println("\t\t\t\t\t"+newSimpleOrComplexObjectElement.getName()+"   "+newSimpleOrComplexObjectElement.getSchemaTypeName());

            if(newSimpleOrComplexObjectElement.getName()!=null&&newSimpleOrComplexObjectElement.getName().equals("FullName")){
            ...
            if(newSimpleOrComplexObjectElement.getSchemaType()!=null){
                ...
                if(newSimpleOrComplexObjectElement.getSchemaType().getClass().toString().contains("org.apache.ws.commons.schema.XmlSchemaSimpleType")){
                    ...
                    if(unionCO!=null){
                        ...
                        if(newSimpleOrComplexObjectElement!=null&&newSimpleOrComplexObjectElement.getMaxOccurs()>1){
                            ComplexObject noArrayCO=new ComplexObject();
                            noArrayCO.setObjectName(no1.getObjectName());
                            noArrayCO.setObjectType(new QName(no1.getObjectType().getNamespaceURI(),no1.getObjectType()+"[]",
                                    no1.getObjectType().getPrefix()));
                            noArrayCO.setIsArrayType(true);
                            noArrayCO.getHasNativeObjects().add(no1);
                            noArrayCO.setIsOptional(no1.isIsOptional());
                ...
                if(!typeParsed){
                    theDefinition.getContainingErrors().add("ERROR 1!!!!! @line ~636");
                        ...
                        if(newSimpleOrComplexObjectElement.getRefName()!=null){
                            ...
                            if(xmlSchemaType==null){
                                ...
                                if(res123!=null){
                                    ...
                                    if(newSimpleOrComplexObjectElement.getQName()!=null){
                                        ...
                                        co123.setObjectName(new QName("UNDEFINED variable name!"));
                                        theDefinition.getContainingErrors().add("ERROR @line ~1695... UNDEFINED Variable name!!!");
                            ...
                            if(xmlSchemaType.getClass().toString().contains("org.apache.ws.commons.schema.XmlSchemaSimpleType")){
                                ...
                                if(newSimpleOrComplexObjectElement.getQName()!=null){
                                    ...
                                    no1.setObjectName(new QName("UNDEFINED variable name"));
                                    theDefinition.getContainingErrors().add("WARNING @line ~202... UNDEFINED Variable name!!!");
                                ...
                                if(newSimpleOrComplexObjectElement.getQName()!=null){
                                    ...
                                    co1.setObjectName(new QName("UNDEFINED variable name"));
                                    theDefinition.getContainingErrors().add("WARNING @line ~1678... UNDEFINED Variable name!!!");
                            ...
                            if(!typeParsed){
                                ...
                                theDefinition.getContainingErrors().add("ERROR 1!!!!! @line ~684");
                                //System.exit(-1);
                            }
    ...
    public static void parseXMLSchemaChoiceElement(AxisService service, org.apache.ws.commons.schema.XmlSchemaChoice choiceElement, ComplexObject choiceCO,
            ParsedWSDLDefinition theDefinition, boolean calledFromAbstractTypeParser){
        XmlSchemaObjectCollection col1= choiceElement.getItems();
        if(col1!=null){
            Iterator iter1=col1.getIterator();
            while(iter1.hasNext()){
                Object newObj2=iter1.next();
                if(newObj2!=null&&newObj2.getClass().getName().contains("org.apache.ws.commons.schema.XmlSchemaElement")){

                    org.apache.ws.commons.schema.XmlSchemaElement newSimpleOrComplexObjectElement=
                            (org.apache.ws.commons.schema.XmlSchemaElement)newObj2;
                    System.out.println("\t\t\t\t\t"+newSimpleOrComplexObjectElement.getName()+"   "+newSimpleOrComplexObjectElement.getSchemaTypeName());
                    ...
                    if(newSimpleOrComplexObjectElement.getSchemaType()!=null){
                        ...
                        if(newSimpleOrComplexObjectElement.getSchemaType().getClass().toString().contains("org.apache.ws.commons.schema.XmlSchemaSimpleType")){
                            ...
                            if(unionCO!=null){
                                if(newSimpleOrComplexObjectElement.getMaxOccurs()>1){
                                    ...
                                    noArrayCO.setIsArrayType(true);
                                    noArrayCO.getHasComplexObjects().add(unionCO);
                                    choiceCO.getHasExtendedObjects().add(noArrayCO);
                                    typeParsed=true;
                            ...
                            ComplexObject co1=new ComplexObject();
                            //edw prepei na mpei elegxos an to newSimpleOrComplexObjectElement->schemaType einai idio me to ct
                            //        gia na apofygw to StackOverflowError
                            ComplexTypesParser.parseComplexType(service, newSimpleOrComplexObjectElement, null, co1, theDefinition, calledFromAbstractTypeParser);
                            typeParsed=true;
                            choiceCO.getHasExtendedObjects().add(co1);
                        ...
                        if(!typeParsed){
                            ...
                            theDefinition.getContainingErrors().add("ERROR 1!!!!!!!!!!!!!!!!!! @line ~2110 Axis2");
                            //System.exit(-1);
                        }
                    }else{
                        System.out.println();
                        ...
                        if(newSimpleOrComplexObjectElement.getSchemaType()==null){
                            ...
                            if (newSimpleOrComplexObjectElement.getSchemaTypeName() != null) {
                                theSchemaType = ParsingUtils.parseWSDLschemasInOrderToFindTheSpecificXMLSchemaType(service, newSimpleOrComplexObjectElement.getSchemaTypeName());
                            } else if (newSimpleOrComplexObjectElement.getRefName() != null) {
                                theSchemaType = ParsingUtils.parseWSDLschemasInOrderToFindTheSpecificXMLSchemaType(service, newSimpleOrComplexObjectElement.getRefName());
                                if (theSchemaType == null) {
                                    theSchemaType = ParsingUtils.parseWSDLschemasInOrderToFindTheSpecificXMLSchemaElement(service, newSimpleOrComplexObjectElement.getRefName());
                                }
                            }
                            System.out.println();
                        }else{
                            theSchemaType=newSimpleOrComplexObjectElement.getSchemaType();
                        }
                        ...
                        if(theSchemaType==null){
                            ...
                            if(res123!=null){
                                if(res123.getClass().getName().contains("NativeObject")){
                                    choiceCO.getHasExtendedObjects().add(res123);
                                    continue;
                                }else if(res123.getClass().getName().contains("ComplexObject")){
                                    choiceCO.getHasExtendedObjects().add(res123);
                                    continue;
                                ...
                                if(newSimpleOrComplexObjectElement.getQName()!=null){
                                    ...
                                    co123.setObjectName(new QName("UNDEFINED variable name!"));
                                    theDefinition.getContainingErrors().add("ERROR @line ~2837... UNDEFINED Variable name!!!");
                        ...
                        if (theSchemaType.getClass().toString().contains("org.apache.ws.commons.schema.XmlSchemaComplexType")) {
                            ComplexObject co1=new ComplexObject();
                            if(newSimpleOrComplexObjectElement.getQName()!=null){
                                co1.setObjectName(newSimpleOrComplexObjectElement.getQName());
                            }else if(newSimpleOrComplexObjectElement.getRefName()!=null){
                                ...
                                co1.setObjectName(new QName("UNDEFINED variable name"));
                                theDefinition.getContainingErrors().add("WARNING @line ~2740... UNDEFINED Variable name!!!");
                                System.out.println("WARNING @line ~2740... UNDEFINED Variable name!!!");
                            }

                            ComplexTypesParser.parseComplexType(service, null, theSchemaType, co1, theDefinition, calledFromAbstractTypeParser);

                            if(newSimpleOrComplexObjectElement!=null&&
                                    (newSimpleOrComplexObjectElement.getMinOccurs()==0||newSimpleOrComplexObjectElement.isNillable())){
                                co1.setIsOptional(true);
                            }
                        ...
                        } else if (theSchemaType.getClass().toString().contains("org.apache.ws.commons.schema.XmlSchemaSimpleType")) {
                            NativeObject no1 = new NativeObject();
                            //no1.objectName = "elementOfArray";
                            //no1.setNamespaceURI(elem1.getSchemaTypeName().getNamespaceURI());
                            no1.setObjectType(newSimpleOrComplexObjectElement.getSchemaTypeName());
                            //no1.setObjectName(newSimpleOrComplexObjectElement.getQName());
                            //no1.additionalInfo = elem1.getSchemaTypeName().getNamespaceURI();
                            if(newSimpleOrComplexObjectElement.getQName()!=null){
                                no1.setObjectName(newSimpleOrComplexObjectElement.getQName());
                            }else if(newSimpleOrComplexObjectElement.getRefName()!=null){
                                no1.setObjectName(newSimpleOrComplexObjectElement.getRefName());
                                ...
                                no1.setObjectName(new QName("UNDEFINED variable name"));
                                theDefinition.getContainingErrors().add("WARNING @line ~495... UNDEFINED Variable name!!!");
                                System.out.println("WARNING @line ~495... UNDEFINED Variable name!!!");
                            }

                            ComplexObject unionCO=SimpleTypesParser.parseSimpleType(null, theSchemaType, no1, theDefinition, service);
                            if(unionCO==null){
                                if(newSimpleOrComplexObjectElement.getMinOccurs()==0||newSimpleOrComplexObjectElement.isNillable()){
                                    no1.setIsOptional(true);
                                }
                                ...
                                if((newSimpleOrComplexObjectElement!=null&&newSimpleOrComplexObjectElement.getMaxOccurs()>1)||
                                    ...
                                    ComplexObject noArrayCO=new ComplexObject();
                                    noArrayCO.setObjectName(no1.getObjectName());
                                    noArrayCO.setObjectType(new QName(no1.getObjectType().getNamespaceURI(),no1.getObjectType().getLocalPart()+"[]",
                                            no1.getObjectType().getPrefix()));
                                    noArrayCO.setIsArrayType(true);
                                    noArrayCO.getHasNativeObjects().add(no1);
                                    noArrayCO.setIsOptional(no1.isIsOptional());
                            ...
                            theDefinition.getContainingErrors().add("ERROR @ line ~980!!!");
                            System.out.println("ERROR @ line ~980!!!");
                        }
                    }
                }else if(newObj2.getClass().getName().contains("org.apache.ws.commons.schema.XmlSchemaSequence")){
                    ...
                    System.out.println();
                     org.apache.ws.commons.schema.XmlSchemaSequence xmlSchemaSequence=
                            (org.apache.ws.commons.schema.XmlSchemaSequence)newObj2;
                    Iterator iter11=xmlSchemaSequence.getItems().getIterator();
                    while(iter11.hasNext()){
                        Object newObj21=iter11.next();
                        if(newObj21!=null&&newObj21.getClass().getName().contains("org.apache.ws.commons.schema.XmlSchemaElement")){

                            org.apache.ws.commons.schema.XmlSchemaElement newSimpleOrComplexObjectElement=
                                    (org.apache.ws.commons.schema.XmlSchemaElement)newObj21;
                            System.out.println("\t\t\t\t\t"+newSimpleOrComplexObjectElement.getName()+"   "+newSimpleOrComplexObjectElement.getSchemaTypeName());

                            XmlSchemaType schemaType=null;
                            if(newSimpleOrComplexObjectElement.getSchemaType()!=null){
                                schemaType=newSimpleOrComplexObjectElement.getSchemaType();
                            }else if(newSimpleOrComplexObjectElement.getRefName()!=null){
                                schemaType = ParsingUtils.parseWSDLschemasInOrderToFindTheSpecificXMLSchemaType(service, newSimpleOrComplexObjectElement.getRefName());
                                if (schemaType == null) {
                                    schemaType = ParsingUtils.parseWSDLschemasInOrderToFindTheSpecificXMLSchemaElement(service, newSimpleOrComplexObjectElement.getRefName());
                                }
                            ...
                            //if(newSimpleOrComplexObjectElement.getSchemaType()!=null){
                            if(schemaType!=null){
                                System.out.println("\t\t\t\t\t\t#"+schemaType.getClass().toString()+"#");

                                boolean typeParsed=false;
                                if(schemaType.getClass().toString().contains("org.apache.ws.commons.schema.XmlSchemaSimpleType")){
                                    NativeObject no1=new NativeObject();
                                    ComplexObject unionCO=SimpleTypesParser.parseSimpleType(newSimpleOrComplexObjectElement, null, no1, theDefinition, service);
                                    if(newSimpleOrComplexObjectElement.getMinOccurs()==0||newSimpleOrComplexObjectElement.isNillable()){
                                        no1.setIsOptional(true);
                                    ...
                                    if(unionCO!=null){
                                        if(newSimpleOrComplexObjectElement.getMaxOccurs()>1){
                                            ...
                                            noArrayCO.setIsArrayType(true);
                                            noArrayCO.getHasComplexObjects().add(unionCO);
                                            sequenceCO.getHasComplexObjects().add(noArrayCO);
                                            typeParsed=true;

                                        }else{
                                            typeParsed=true;
                                            sequenceCO.getHasComplexObjects().add(unionCO);
                                        }
                                        System.out.println();
                                    }else{
                                        if(no1!=null&&no1.getAdditionalInfo()!=null&&no1.getAdditionalInfo().contains("isListType")){
                                            ...
                                            if(newSimpleOrComplexObjectElement.getMaxOccurs()>1){
                                                ...
                                                typeParsed=true;
                                                sequenceCO.getHasNativeObjects().add(no1);
                                            }
                                        }
                                    }

                                }else if(schemaType.getClass().toString().contains("org.apache.ws.commons.schema.XmlSchemaComplexType")){
                                    ComplexObject co1=new ComplexObject();
                                    //edw prepei na mpei elegxos an to newSimpleOrComplexObjectElement->schemaType einai idio me to ct
                                    //        gia na apofygw to StackOverflowError
                                    if(newSimpleOrComplexObjectElement.getSchemaType()!=null){
                                        ...
                                        ComplexTypesParser.parseComplexType(service, null, schemaType, co1, theDefinition, calledFromAbstractTypeParser);
                                        if(newSimpleOrComplexObjectElement!=null&&(newSimpleOrComplexObjectElement.getMinOccurs()==0||
                                        ...
                                        if(newSimpleOrComplexObjectElement!=null&&newSimpleOrComplexObjectElement.getMaxOccurs()>1){
                                            ...
                                            coArrayCO.getHasComplexObjects().add(co1);
                                            coArrayCO.setIsOptional(co1.isIsOptional());
                                            sequenceCO.getHasComplexObjects().add(coArrayCO);
                                        }else{
                                            sequenceCO.getHasComplexObjects().add(co1);
                                        }
                                    }
                                ...
                                if(!typeParsed){
                                    ...
                                    theDefinition.getContainingErrors().add("ERROR 1!!!!!!!!!!!!!!!!!! @line ~2648 Axis2");
                                    //System.exit(-1);
                                }
                                System.out.println();
                            }else{
                        ...
                        }else if(newObj21!=null&&newObj21.getClass().getName().contains("org.apache.ws.commons.schema.XmlSchemaChoice")){
                            ...
                            newChoiceCO.setObjectName(new QName("http://www.w3.org/2001/XMLSchema", "XmlSchemaChoice"));
                            newChoiceCO.setObjectType(new QName("http://www.w3.org/2001/XMLSchema", "XmlSchemaChoice"));
                            newChoiceCO.setIsAbstract(true);

                            AdditionalTypesParser.parseXMLSchemaChoiceElement(service, schemaChoice, newChoiceCO,
                            ...
                            if(schemaChoice.getMaxOccurs()>1){
                                ...
                                new_arrayCO.setObjectName(newChoiceCO.getObjectName());
                                //arrayCO.setObjectType(new QName(co1.getObjectType()+"[]"));
                                new_arrayCO.setObjectType(new QName(newChoiceCO.getObjectType().getNamespaceURI(),
                                                                    newChoiceCO.getObjectType().getLocalPart()+"[]",
                                                                    newChoiceCO.getObjectType().getPrefix()));
                                new_arrayCO.setIsArrayType(true);
                                new_arrayCO.getHasComplexObjects().add(newChoiceCO);
                                new_arrayCO.setIsOptional(newChoiceCO.isIsOptional());
                                sequenceCO.getHasComplexObjects().add(new_arrayCO);
                            }else{
                                sequenceCO.getHasComplexObjects().add(newChoiceCO);
                            }

                            //System.out.println("\t\t\t\t\t"+newSimpleOrComplexObjectElement.getName()+"   "+newSimpleOrComplexObjectElement.getSchemaTypeName());
                            System.out.println("aaa!");
                        }else if(newObj21!=null&&newObj21.getClass().getName().contains("org.apache.ws.commons.schema.XmlSchemaAny")){
                            try{
                                org.apache.ws.commons.schema.XmlSchemaAny newSimpleOrComplexObjectElement=
                                        (org.apache.ws.commons.schema.XmlSchemaAny)newObj21;
                                ...
                                if(newSimpleOrComplexObjectElement.getMaxOccurs()>1){
                                    ...
                                    sequenceCO.getHasComplexObjects().add(arrayCO);
                                }else{
                                    sequenceCO.getHasComplexObjects().add(co1);
                                }
    ...
    public static void parseXMLSchemaSimpleTypeUnionElement(AxisService service, org.apache.ws.commons.schema.XmlSchemaSimpleTypeUnion unionElement, ComplexObject unionCO,
            ParsedWSDLDefinition theDefinition, boolean calledFromAbstractTypeParser){
        ...
        if(memberTypeNames==null||memberTypeNames.length==0){
            ...
            while(iter1.hasNext()){
                ...
                if(obj!=null&&obj.getClass().getName().contains("XmlSchemaSimpleType")){
                    ...
                    ComplexObject unionCO2=SimpleTypesParser.parseSimpleType(null, xmlSchemaSimpleType, no1, theDefinition, service);
                    if(unionCO2==null){
            ...
            for(int i=0;i<memberTypeNames.length;i++){
                ...
                XmlSchemaType xmlSchemaType = ParsingUtils.parseWSDLschemasInOrderToFindTheSpecificXMLSchemaType(service, memberQName);
                if (xmlSchemaType == null) {
                    xmlSchemaType = ParsingUtils.parseWSDLschemasInOrderToFindTheSpecificXMLSchemaElement(service, memberQName);
                }
                if(xmlSchemaType==null){
                    System.out.println();
                    if(memberQName.getNamespaceURI().equals("http://www.w3.org/2001/XMLSchema")){
                        NativeObject no1 = new NativeObject();
                        //no1.objectName = "elementOfArray";
                    ...
                    if(xmlSchemaType.getClass().getName().contains("XmlSchemaSimpleType")){
                        ...
                        ComplexObject newCO=SimpleTypesParser.parseSimpleType(null, xmlSchemaType, no1, theDefinition, service);
    ...
    public static Object parseXmlSchemaAttribute(XmlSchemaAttribute xmlSchemaAttribute, AxisService service, ParsedWSDLDefinition theDefinition){
        //RETURNS NativeObjet or ComplexObject
        if(xmlSchemaAttribute==null)return null;

        System.out.println(xmlSchemaAttribute.getName());
        if(xmlSchemaAttribute.getSchemaTypeName()!=null&&xmlSchemaAttribute.getSchemaTypeName().getNamespaceURI()!=null&&
                xmlSchemaAttribute.getSchemaTypeName().getNamespaceURI().contains("http://www.w3.org/2001/XMLSchema")){
            ...
            //FIND THE TYPE!
            //parse it...
            XmlSchemaType xmlSchemaType1 = ParsingUtils.parseWSDLschemasInOrderToFindTheSpecificXMLSchemaType(service, xmlSchemaAttribute.getSchemaTypeName());
            if (xmlSchemaType1 == null) {
                xmlSchemaType1 = ParsingUtils.parseWSDLschemasInOrderToFindTheSpecificXMLSchemaElement(service, xmlSchemaAttribute.getSchemaTypeName());
            }
            ...
            if (xmlSchemaType1 == null) {
                if (xmlSchemaAttribute.getRefName() != null) {
                    xmlSchemaType1 = ParsingUtils.parseWSDLschemasInOrderToFindTheSpecificXMLSchemaType(service, xmlSchemaAttribute.getRefName());
                    if (xmlSchemaType1 == null) {
                        xmlSchemaType1 = ParsingUtils.parseWSDLschemasInOrderToFindTheSpecificXMLSchemaElement(service, xmlSchemaAttribute.getRefName());
                    }
                }
                System.out.println();
            }
            ...
            if(xmlSchemaType1==null){
                Object res123= ParsingUtils.tryToFindAndParseAttributeForSpecificObject(theDefinition, service, xmlSchemaAttribute.getRefName());
                if(res123!=null){
                    return res123;
                }else{
                    System.out.println("XA! W!");
                    ...
                    if(xmlSchemaAttribute.getQName()!=null){
                        ...
                        theDefinition.getContainingErrors().add("ERROR @line ~2968... UNDEFINED Variable name!!!");
            ...
            if(xmlSchemaType1.getClass().getName().contains("XmlSchemaComplexType")){
                ...
                ComplexTypesParser.parseComplexType(service, null, xmlSchemaType1, co1, theDefinition, false);
                co1.setObjectName(co1.getObjectType());
                co.getHasComplexObjects().add(co1);

            }else if(xmlSchemaType1.getClass().getName().contains("XmlSchemaSimpleType")){
                NativeObject no1 = new NativeObject();
                ...
                if(unionCO==null){
                    if((co.getHasComplexObjects()==null||co.getHasComplexObjects().size()==0)&&
                        (co.getHasNativeObjects()==null||co.getHasNativeObjects().size()==0)){
                    ...
                    if(no1.getObjectName()==null){
                        no1.setObjectName(new QName("UNDEFINED variable name"));
                        theDefinition.getContainingErrors().add("ERROR @line ~3001... UNDEFINED Variable name!!!");
    ...
    public static void parseAllExtensionTypesOfTheAbstractType(AxisService service, ComplexObject co, QName abstractTypeName, ParsedWSDLDefinition theDefinition) {
        ...
        for(int i=0;i<schemasList.size();i++){
             ...
             while(typesIter.hasNext()){
                 org.apache.ws.commons.schema.XmlSchemaType type=
                         (org.apache.ws.commons.schema.XmlSchemaType)typesIter.next();

                 if(type.getClass().getName().contains("org.apache.ws.commons.schema.XmlSchemaComplexType")){
                     org.apache.ws.commons.schema.XmlSchemaComplexType type1=(org.apache.ws.commons.schema.XmlSchemaComplexType)type;

                     if(type1.getContentModel()!=null&&type1.getContentModel().getContent()!=null&&
                             type1.getContentModel().getContent().getClass().getName().contains("XmlSchemaComplexContentExtension")){
                         XmlSchemaComplexContentExtension extensionContent=(XmlSchemaComplexContentExtension)type1.getContentModel().getContent();
                         if(extensionContent.getBaseTypeName().equals(abstractTypeName)){
                             System.out.println(extensionContent.getBaseTypeName());
                             ComplexObject co1=new ComplexObject();
                             ...
                             XmlSchemaType xmlSchemaType1 = ParsingUtils.parseWSDLschemasInOrderToFindTheSpecificXMLSchemaType(service, type1.getQName());
                             if (xmlSchemaType1 == null) {
                                 xmlSchemaType1 = ParsingUtils.parseWSDLschemasInOrderToFindTheSpecificXMLSchemaElement(service, type1.getQName());
                             }

                             if(xmlSchemaType1.getClass().getName().contains("XmlSchemaComplexType")){
                                 ComplexTypesParser.parseComplexType(service, null, xmlSchemaType1, co1, theDefinition, true);

                             }else{
                                 System.out.println("ERROR @line ~348");
                                 theDefinition.getContainingErrors().add("ERROR @line ~348");
                             }
    ...
    public static void parseArrayType(AxisService service, ComplexObject arrayCO, QName qName, ParsedWSDLDefinition theDefinition,
            org.apache.ws.commons.schema.XmlSchemaType inXmlSchemaType, boolean calledFromAbstractTypeParser) {
        ...
        if(el1!=null){
            ...
            xmlSchemaType=ParsingUtils.parseWSDLschemasInOrderToFindTheSpecificXMLSchemaType(service, qName);
            if(xmlSchemaType==null){
                xmlSchemaType=ParsingUtils.parseWSDLschemasInOrderToFindTheSpecificXMLSchemaElement(service, qName);
            }
        }
        ...
        if(xmlSchemaType!=null){
            try{
                ...
                if(xmlSchemaType.getClass().getName().contains("org.apache.ws.commons.schema.XmlSchemaSimpleType")){
                    ...
                    ComplexObject unionCO2=SimpleTypesParser.parseSimpleType(null, xmlSchemaType, containedNO, theDefinition, service);
                    if(unionCO2==null){
                        if((el1!=null&&el1.getMaxOccurs()>1)||(containedNO.getAdditionalInfo()!=null&&containedNO.getAdditionalInfo().contains("isListType"))){
                            ComplexObject noArrayCO=new ComplexObject();
                            noArrayCO.setObjectName(containedNO.getObjectName());
                            noArrayCO.setObjectType(new QName(containedNO.getObjectType().getNamespaceURI(),containedNO.getObjectType().getLocalPart()+"[]",
                                    containedNO.getObjectType().getPrefix()));
                            noArrayCO.setIsArrayType(true);
                ...
                //ct: the ComplexType of the complex objects (containedCO) that can be contained in the arrayCO
                ...
                if(ct.getContentModel()==null){
                    ...
                    if(ct.getParticle()!=null){
                        if(ct.getParticle().getClass().getName().equals("org.apache.ws.commons.schema.XmlSchemaSequence")){
                            org.apache.ws.commons.schema.XmlSchemaSequence seq=(org.apache.ws.commons.schema.XmlSchemaSequence)ct.getParticle();
                            if(seq!=null){
                        ...
                        }else if(ct.getParticle().getClass().getName().equals("org.apache.ws.commons.schema.XmlSchemaChoice")){
                            org.apache.ws.commons.schema.XmlSchemaChoice schemaChoice=(org.apache.ws.commons.schema.XmlSchemaChoice)ct.getParticle();
                            if(schemaChoice!=null){
                                System.out.println();
                                containedCO.setObjectName(new QName("http://www.w3.org/2001/XMLSchema", "XmlSchemaChoice"));
                                containedCO.setObjectType(new QName("http://www.w3.org/2001/XMLSchema", "XmlSchemaChoice"));
                                containedCO.setIsAbstract(true);

                                AdditionalTypesParser.parseXMLSchemaChoiceElement(service, schemaChoice, containedCO,
                                        theDefinition, calledFromAbstractTypeParser);
                                ...
                                if(schemaChoice.getMaxOccurs()>1){
                                    //Array Type
                                    try{
                                        arrayCO.getHasComplexObjects().remove(containedCO);
                                    }catch(Exception e){
                                       e.printStackTrace();
                                    }
                                    ComplexObject new_arrayCO=new ComplexObject();
                                    new_arrayCO.setObjectName(containedCO.getObjectName());
                                    //arrayCO.setObjectType(new QName(co1.getObjectType()+"[]"));
                                    new_arrayCO.setObjectType(new QName(containedCO.getObjectType().getNamespaceURI(),
                                                                        containedCO.getObjectType().getLocalPart()+"[]",
                                                                        containedCO.getObjectType().getPrefix()));
                                    new_arrayCO.setIsArrayType(true);
                                    new_arrayCO.getHasComplexObjects().add(containedCO);
                                    new_arrayCO.setIsOptional(containedCO.isIsOptional());
                                    arrayCO.getHasComplexObjects().add(new_arrayCO);
                                }else{
                                    //arrayCO.getHasComplexObjects().add(containedCO);
                                }
                    ...
                    if(ct.getContentModel().getClass().getName().contains("XmlSchemaSimpleContent")){
                        ...
                        SimpleTypesParser.parseSimpleContent(service, simpleContent, containedCO, theDefinition);
                        if(containedCO.getObjectName()==null||containedCO.getObjectName().getLocalPart().equals("Error")){
                            System.out.println();
                            //prepei na vrw ti name kai type tha tou valw
                        }
                        System.out.println();
                    }else{
                        org.apache.ws.commons.schema.XmlSchemaComplexContent cc = (org.apache.ws.commons.schema.XmlSchemaComplexContent) ct.getContentModel();
                        System.out.println(cc.getContent().getClass());
                        if(cc.getContent().getClass().getName().contains("org.apache.ws.commons.schema.XmlSchemaComplexContentExtension")){
                            //COMPLEX CONTENT!!!
                            if(containedCO.getObjectName()==null){
                                containedCO.setObjectName(arrayCO.getObjectName());
                            }
                            ...
                            ComplexTypesParser.parseComplexContent(service, cc, containedCO, theDefinition, calledFromAbstractTypeParser, containedCO.getObjectType());
                        ...
                        }else if(cc.getContent().getClass().getName().contains("org.apache.ws.commons.schema.XmlSchemaComplexContentRestriction")){
                            org.apache.ws.commons.schema.XmlSchemaComplexContentRestriction restriction =
                                    (org.apache.ws.commons.schema.XmlSchemaComplexContentRestriction) cc.getContent();
                            if (restriction.getParticle() != null) //CHECK ADDED DJ,GIORGOS, 5-12-2008
                            {
                                System.out.println(restriction.getParticle().getClass());
                                org.apache.ws.commons.schema.XmlSchemaSequence seq = (org.apache.ws.commons.schema.XmlSchemaSequence) restriction.getParticle();
                                iter1 = seq.getItems().getIterator();
                            } else if (restriction.getAttributes() != null) {
                                iter1 = restriction.getAttributes().getIterator();
                ...
                {
                    while (iter1.hasNext()) {
                        org.apache.ws.commons.schema.XmlSchemaObject abstractElem = (org.apache.ws.commons.schema.XmlSchemaObject) iter1.next();
                        ...
                        if (abstractElem instanceof org.apache.ws.commons.schema.XmlSchemaElement) {
                            ...
                            if (elem1 != null) {
                                ...
                                if(elem1.getSchemaType()==null){
                                    ...
                                    if (elem1.getSchemaTypeName() != null) {
                                        theSchemaType = ParsingUtils.parseWSDLschemasInOrderToFindTheSpecificXMLSchemaType(service, elem1.getSchemaTypeName());
                                        /*
                                        if (xmlSchemaType == null) {
                                            xmlSchemaType = parseWSDLschemasInOrderToFindTheSpecificXMLSchemaElement(service, schElemOfType.getSchemaTypeName());
                                        }*/
                                    } else if (elem1.getRefName() != null) {
                                        theSchemaType = ParsingUtils.parseWSDLschemasInOrderToFindTheSpecificXMLSchemaType(service, elem1.getRefName());
                                        if (theSchemaType == null) {
                                            theSchemaType = ParsingUtils.parseWSDLschemasInOrderToFindTheSpecificXMLSchemaElement(service, elem1.getRefName());
                                        }
                                    }
                                    System.out.println();
                                }else{
                                ...
                                if(theSchemaType==null){
                                    Object res123= ParsingUtils.tryToFindAndParseAttributeForSpecificObject(theDefinition, service, elem1.getRefName());
                                    if(res123!=null){
                                        if(res123.getClass().getName().contains("NativeObject")){
                                            containedCO.getHasNativeObjects().add(res123);
                                            continue;
                                        }else if(res123.getClass().getName().contains("ComplexObject")){
                                            containedCO.getHasComplexObjects().add(res123);
                                            continue;
                                        }
                                        ...
                                        if(elem1.getQName()!=null){
                                            co123.setObjectName(elem1.getQName());
                                        }else if(elem1.getRefName()!=null){
                                            co123.setObjectName(elem1.getRefName());
                                        }else if(elem1.getName()!=null){
                                            co123.setObjectName(new QName(elem1.getName()));
                                        }else{
                                            co123.setObjectName(new QName("UNDEFINED variable name!"));
                                            theDefinition.getContainingErrors().add("ERROR @line ~1036... UNDEFINED Variable name!!!");
                                            System.out.println("ERROR @line ~1036... UNDEFINED Variable name!!!");
                                        }

                                        co123.setObjectType(new QName("Object"));
                                        containedCO.getHasComplexObjects().add(co123);
                                    }
                                    continue;
                                }
                                ...
                                if (theSchemaType.getClass().toString().contains("org.apache.ws.commons.schema.XmlSchemaComplexType")) {
                                    ...
                                    if(elem1.getQName()!=null){
                                        ...
                                        co1.setObjectName(new QName("UNDEFINED variable name"));
                                        theDefinition.getContainingErrors().add("WARNING @line ~1024... UNDEFINED Variable name!!!");
                                        System.out.println("WARNING @line ~1024... UNDEFINED Variable name!!!");
                                    }

                                    ComplexTypesParser.parseComplexType(service, null, theSchemaType, co1, theDefinition, calledFromAbstractTypeParser);

                                    if(elem1!=null&&(elem1.getMinOccurs()==0||elem1.isNillable())){
                                        co1.setIsOptional(true);
                                    }

                                    if(elem1!=null&&elem1.getMaxOccurs()>1){
                                        ComplexObject coArrayCO=new ComplexObject();
                                        coArrayCO.setObjectName(co1.getObjectName());
                                        //co1.setObjectType(new QName("XA!"));
                                        coArrayCO.setObjectType(new QName(co1.getObjectType().getNamespaceURI(),co1.getObjectType().getLocalPart()+"[]",
                                        ...
                                        coArrayCO.getHasComplexObjects().add(co1);
                                        coArrayCO.setIsOptional(co1.isIsOptional());
                                        containedCO.getHasComplexObjects().add(coArrayCO);
                                    ...
                                    //co.isArrayType=true;
                                    //co.objectType = elem1.getSchemaTypeName().getLocalPart() + "[]";
                                    ...
                                    if(elem1.getQName()!=null){
                                        ...
                                        no1.setObjectName(new QName("UNDEFINED variable name"));
                                        theDefinition.getContainingErrors().add("WARNING @line ~1051... UNDEFINED Variable name!!!");
                                    ...
                                    if(unionCO==null){
                                        ...
                                        if((elem1!=null&&elem1.getMaxOccurs()>1)||(no1.getAdditionalInfo()!=null&&no1.getAdditionalInfo().contains("isListType"))){
                                            ComplexObject noArrayCO=new ComplexObject();
                                            noArrayCO.setObjectName(no1.getObjectName());
                                            noArrayCO.setObjectType(new QName(no1.getObjectType().getNamespaceURI(),no1.getObjectType().getLocalPart()+"[]",
                                                    no1.getObjectType().getPrefix()));
                            ...
                            if (elem1 != null) {
                                if (elem1.getSchemaType() != null) {
                                    if (elem1.getSchemaType().getClass().toString().contains("org.apache.ws.commons.schema.XmlSchemaComplexType")) {
                                        ComplexObject co1=new ComplexObject();
                                        if(elem1.getQName()!=null){
                                            co1.setObjectName(elem1.getQName());//Panta prin apo ayto ton tropo klisis prepei na exw dwsei prwta to onoma tou co
                                        }else if(elem1.getRefName()!=null){
                                            co1.setObjectName(elem1.getRefName());
                                        }else if(elem1.getName()!=null){
                                            co1.setObjectName(new QName(elem1.getName()));
                                            ...
                                            co1.setObjectName(new QName("UNDEFINED variable name"));
                                            theDefinition.getContainingErrors().add("WARNING @line ~1095... UNDEFINED Variable name!!!");
                                            System.out.println("WARNING @line ~1095... UNDEFINED Variable name!!!");
                                        }

                                        ComplexTypesParser.parseComplexType(service, null, elem1.getSchemaType(), co1, theDefinition, calledFromAbstractTypeParser);

                                        //co.objectType = elem1.getSchemaTypeName().getLocalPart() + "[]";
                                        //co.setNamespaceURI(elem1.getSchemaTypeName().getNamespaceURI());
                                        containedCO.getHasComplexObjects().add(co1);
                                        //co.isArrayType=true;
                                    } else if (elem1.getSchemaType().getClass().toString().contains("org.apache.ws.commons.schema.XmlSchemaSimpleType")) {
                                        NativeObject no1 = new NativeObject();
                                        ...
                                        if(elem1.getQName()!=null){
                                            ...
                                            no1.setObjectName(new QName("UNDEFINED variable name"));
                                            theDefinition.getContainingErrors().add("WARNING @line ~1128... UNDEFINED Variable name!!!");
                                        ...
                                        ComplexObject unionCO=SimpleTypesParser.parseSimpleType(null, elem1.getSchemaType(), no1, theDefinition, service);
                                        if(unionCO==null){
                                            if(no1.getAdditionalInfo()!=null&&no1.getAdditionalInfo().contains("isListType")){
                                                ComplexObject noArrayCO=new ComplexObject();
                                                noArrayCO.setObjectName(no1.getObjectName());
                                        ...
                                        theDefinition.getContainingErrors().add("ERROR @ line ~394!!!");
                                    ...
                                    if(arrayCO.getObjectType()!=null){
                                        String type1=arrayCO.getObjectType().getLocalPart().replace("[]", "");
                                        QName qName1=new QName(qName.getNamespaceURI(), type1, qName.getPrefix());

                                        XmlSchemaType xmlSchemaType1 = ParsingUtils.parseWSDLschemasInOrderToFindTheSpecificXMLSchemaType(service, qName1);
                                        if (xmlSchemaType1 == null) {
                                            xmlSchemaType1 = ParsingUtils.parseWSDLschemasInOrderToFindTheSpecificXMLSchemaElement(service, qName1);
                                        }
                                        ...
                                        if(xmlSchemaType1.getClass().getName().contains("XmlSchemaComplexType")){
                                            ...
                                            if(elem1.getQName()!=null){
                                                ...
                                                co1.setObjectName(new QName("UNDEFINED variable name"));
                                                theDefinition.getContainingErrors().add("WARNING @line ~1162... UNDEFINED Variable name!!!");
                                                System.out.println("WARNING @line ~1162... UNDEFINED Variable name!!!");
                                            }

                                            ComplexTypesParser.parseComplexType(service, null, xmlSchemaType1, co1, theDefinition, calledFromAbstractTypeParser);

                                            //co.objectType = xmlSchemaType1.getQName().getLocalPart() + "[]";
                                            ...
                                            if(elem1.getQName()!=null){
                                                ...
                                                no1.setObjectName(new QName("UNDEFINED variable name"));
                                                theDefinition.getContainingErrors().add("WARNING @line ~1208... UNDEFINED Variable name!!!");
                                        ...
                                        theDefinition.getContainingErrors().add("ERROR @ line ~426!!!");
                            ...
                            if(elem1.getMaxOccurs()>1){
                                ...
                                containedCO.getHasComplexObjects().add(arrayCO1);
                            }else{
                                containedCO.getHasComplexObjects().add(co1);
                            }
                            ...
                            theDefinition.getContainingErrors().add("ERROR @ Axis2 line ~1140!!!");
                ...
                if(attsCol!=null){
                    ...
                    while(iter2.hasNext()){
                        ...
                        if(obj.getClass().getName().equals("org.apache.ws.commons.schema.XmlSchemaAttribute")){
                            ...
                            Object res1=parseXmlSchemaAttribute(att, service, theDefinition);
                            if(res1!=null){
                                if(res1.getClass().getName().contains("NativeObject")){
                                    ...
                                    containedCO.getHasComplexObjects().add(co12);
                                }
                            }
                        }
                            ...
                            if(co1!=null){
                                for(int i=0;i<co1.getHasComplexObjects().size();i++){
                                    containedCO.getHasComplexObjects().add(co1.getHasComplexObjects().get(i));
                                }
                                for(int i=0;i<co1.getHasNativeObjects().size();i++){
                                    containedCO.getHasNativeObjects().add(co1.getHasNativeObjects().get(i));
                                }
                            }else{
                                System.out.println();
                            }
    ...
    public static ComplexObject getArrayCoForNo(XmlSchemaElement schElemOfType, XmlSchemaType xmlSchemaType, NativeObject no, ParsedWSDLDefinition theDefinition){

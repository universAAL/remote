...
public class Axis2ParserWrapper {
    ...
    public static ParsedWSDLDefinition parseWSDLwithAxis2(String wsdlURL) {
        ...
        try {
            ...
            //URL url=new URL("http://www-1.munimadrid.es/MappingService/wsdl/es/indra/askit/mappingws/MappingService.wsdl");
            //Needs XML validation OFF gia na paiksei???

            //URL url=new URL("http://www.verona.miz.it/mpk4/server?wsdl");                        
            //URL url=new URL("http://138.4.10.246:8080/AskItHemService/AskItHemService?wsdl");
            //URL url=new URL("http://195.251.117.248/TransportRequestWS/TransportRequestWS.asmx?WSDL");
            ...
            try {
                service = org.apache.axis2.description.AxisService.createClientSideAxisService(url,
                        null, null, options);
            ...
            theDefinition.setWebServiceName(new QName(service.getTargetNamespace(), service.getName(), service.getTargetNamespacePrefix()));
...
//                if (operationName.equals("") || operationName.equalsIgnoreCase(oper.getName().getLocalPart()))
                {
...
if(oper.getName().getLocalPart().equalsIgnoreCase("Getmyevents")){
    System.out.println();
                    ...
                    if (oper.getClass().getName().contains("OutOnlyAxisOperation")) {
                        ...
                        //Change direction gia na diorthwthei to sfalma tou Axis2 kai na mpei swsta to message se Input i Output
                    ...
                    while (msgIter.hasNext()) {
                        ...
                        //EDW FAINETAI AN EINAI SimpleType i ComplexType to input / output
                        ...
                        if (el.getSchemaType() != null && el.getSchemaType().getClass().getName().contains("XmlSchemaComplexType")) {
                        ...
                        if (ct != null) {
                            ...
                            if (ct != null) {
                                if (ct.getParticle() != null) {
                                    //-System.out.prinln("\t\t" + "Particle class: " + ct.getParticle().getClass());
                                }
                                if (ct.getAttributes() != null) {
                                    //-System.out.prinln("\t\t" + ct.getAttributes().getCount());
                                }
                            }

                            org.apache.ws.commons.schema.XmlSchemaSequence particleSequence = null;
                            if (ct.getParticle() != null && ct.getParticle().getClass().getName().contains("XmlSchemaSequence")) {
                                particleSequence = (org.apache.ws.commons.schema.XmlSchemaSequence) ct.getParticle();

                            } else if (ct.getParticle() != null && ct.getParticle().getClass().getName().contains("XmlSchemaAll")) {
                                System.out.println();
                                ...
                                AdditionalTypesParser.parseXmlSchemaAllType(service, xsa, dummyInputOrOutputComplexObject, theDefinition);
                                ...
                                if (msg.isWrapped()) {
                                    if (msg.getDirection().equals("in")) {
                                        operationInput.setHasSoapHeaders(parseSoapHeadersOfOperation(service, msg, theDefinition));
                                        ...
                                        if (dummyInputOrOutputComplexObject.getHasComplexObjects().size() == 0 &&
                                            ...
                                            operationInput.getHasNativeOrComplexObjects().add(dummyInputOrOutputComplexObject.getHasNativeObjects().get(0));
                                        } else {
                                            for (int i = 0; i < dummyInputOrOutputComplexObject.getHasNativeObjects().size(); i++) {
                                                operationInput.getHasNativeOrComplexObjects().add(dummyInputOrOutputComplexObject.getHasNativeObjects().get(i));
                                            }
                                            for (int i = 0; i < dummyInputOrOutputComplexObject.getHasComplexObjects().size(); i++) {
                                                operationInput.getHasNativeOrComplexObjects().add(dummyInputOrOutputComplexObject.getHasComplexObjects().get(i));
                                            }
                                        }
                                        ...
                                        if (dummyInputOrOutputComplexObject.getHasComplexObjects().size() == 0 &&
                                                dummyInputOrOutputComplexObject.getHasNativeObjects().size() == 1) {
                                            operationOutput.getHasNativeOrComplexObjects().add(dummyInputOrOutputComplexObject.getHasNativeObjects().get(0));
                                        } else {
                                            for (int i = 0; i < dummyInputOrOutputComplexObject.getHasNativeObjects().size(); i++) {
                                                operationOutput.getHasNativeOrComplexObjects().add(dummyInputOrOutputComplexObject.getHasNativeObjects().get(i));
                                            }
                                            for (int i = 0; i < dummyInputOrOutputComplexObject.getHasComplexObjects().size(); i++) {
                                                operationOutput.getHasNativeOrComplexObjects().add(dummyInputOrOutputComplexObject.getHasComplexObjects().get(i));
                                            }
                                        }
                                    }
                                } else { //if NOT WRAPPED
                                    //TWRA GINETAI TO IDIO OPWS sto WRAPPED apo panw...
                                    if (msg.getDirection().equals("in")) {
                                        operationInput.setHasSoapHeaders(parseSoapHeadersOfOperation(service, msg, theDefinition));
                            ...
                            if (particleSequence != null) {
                                ...
                                //EDW NA GINEI CHECK sta namespaces gia na mpei to katallilo prefix
                                dummyInputOrOutputComplexObject.setObjectName(msg.getElementQName());

                                /*
                                if(dummyInputOrOutputComplexObject.getObjectName().getLocalPart().contains("HotelAvailRQ")){
                                System.out.println();
                                }*/
                                ...
                                while (particleIter.hasNext()) {
                                    ...
                                    if (newObj1 != null && newObj1.getClass().getName().equals("org.apache.ws.commons.schema.XmlSchemaElement")) {

                                        org.apache.ws.commons.schema.XmlSchemaElement schElemOfType =
                                                (org.apache.ws.commons.schema.XmlSchemaElement) newObj1;

                                        System.out.println("\t\t\t" + schElemOfType.getName() + "   " + schElemOfType.getSchemaTypeName());

                                        if (schElemOfType.getSchemaType() != null) {
                                            System.out.println("\t\t\t\t#" + schElemOfType.getSchemaType().getClass().toString() + "#");

                                            boolean typeParsed = false;
                                            if (schElemOfType.getSchemaType().getClass().toString().contains("org.apache.ws.commons.schema.XmlSchemaSimpleType")) {
                                                NativeObject no1 = new NativeObject();
                                                no1.setObjectName(schElemOfType.getQName());
                                                ComplexObject unionCO = SimpleTypesParser.parseSimpleType(schElemOfType, null, no1, theDefinition, service);
                                                typeParsed = true;
                                                if (unionCO != null) {
                                            ...
                                            } else if (schElemOfType.getSchemaType().getClass().toString().contains("org.apache.ws.commons.schema.XmlSchemaComplexType")) {
                                                ...
                                                if (schElemOfType.getMaxOccurs() > 1) {
                                                    if (!co1.isIsArrayType()) {
                                                        ...
                                                        co2.setObjectType(new QName(co1.getObjectType().getNamespaceURI(),
...
//
                                            ...
                                            if (!typeParsed) {
                                                ...
                                                theDefinition.getContainingErrors().add("ERROR 1!!!!!!!!!!!!!!!!!! @line ~191");
                                                //-System.exit(-1);
                                            }
                                        } else {

                                            //PREPEI NA PSAKSW TO schemaType sto service
                                            org.apache.ws.commons.schema.XmlSchemaType xmlSchemaType = null;
                                            if (schElemOfType.getSchemaTypeName() != null) {
                                                xmlSchemaType = ParsingUtils.parseWSDLschemasInOrderToFindTheSpecificXMLSchemaType(service, schElemOfType.getSchemaTypeName());
                                                /*
                                                ...
                                                xmlSchemaType = ParsingUtils.parseWSDLschemasInOrderToFindTheSpecificXMLSchemaType(service, schElemOfType.getRefName());
                                                if (xmlSchemaType == null) {
                                                    xmlSchemaType = ParsingUtils.parseWSDLschemasInOrderToFindTheSpecificXMLSchemaElement(service, schElemOfType.getRefName());
                                                }
                                            }
                                            ...
                                            if (xmlSchemaType == null) {
                                                //failedDueToAxisCreation=true;
                                                //return null;
                                                Object res123 = ParsingUtils.tryToFindAndParseAttributeForSpecificObject(theDefinition, service, schElemOfType.getRefName());
                                                if (res123 != null) {
                                                    if (res123.getClass().getName().contains("NativeObject")) {
                                                        dummyInputOrOutputComplexObject.getHasNativeObjects().add(res123);
                                                        continue;
                                                    } else if (res123.getClass().getName().contains("ComplexObject")) {
                                                        dummyInputOrOutputComplexObject.getHasComplexObjects().add(res123);
                                                        continue;
                                                    }
                                                    ...
                                                    if (schElemOfType.getQName() != null) {
                                                        ...
                                                        theDefinition.getContainingErrors().add("ERROR @line ~324... UNDEFINED Variable name!!!");
                                            ...
                                            if (xmlSchemaType.getClass().toString().contains("org.apache.ws.commons.schema.XmlSchemaSimpleType")) {
                                                ...
                                                if (schElemOfType.getQName() != null) {
                                                    ...
                                                    theDefinition.getContainingErrors().add("WARNING @line ~457... UNDEFINED Variable name!!!");
                                                ...
                                                if (unionCO == null) {
                                                    if (schElemOfType != null && (schElemOfType.getMinOccurs() == 0 || schElemOfType.isNillable())) {
                                                        no1.setIsOptional(true);
                                                    }

                                                    System.out.println();
                                                    typeParsed = true;
                                                    if (schElemOfType.getMaxOccurs() > 1 || (no1.getAdditionalInfo() != null && no1.getAdditionalInfo().contains("isListType"))) {
                                                        ComplexObject noArrayCO = new ComplexObject();
                                                        noArrayCO.setObjectName(no1.getObjectName());
                                                        noArrayCO.setObjectType(new QName(no1.getObjectType().getNamespaceURI(), no1.getObjectType() + "[]", no1.getObjectType().getPrefix()));
                                                        noArrayCO.setIsArrayType(true);
                                                        noArrayCO.getHasNativeObjects().add(no1);
                                                        noArrayCO.setIsOptional(no1.isIsOptional());
                                                        dummyInputOrOutputComplexObject.getHasComplexObjects().add(noArrayCO);
                                                ...
                                                ComplexObject co1 = new ComplexObject();
                                                if (schElemOfType.getQName() != null) {
                                                    co1.setObjectName(schElemOfType.getQName());//Panta prin apo ayto ton tropo klisis prepei na exw dwsei prwta to onoma tou co
                                                } else if (schElemOfType.getRefName() != null) {
                                                    ...
                                                    theDefinition.getContainingErrors().add("WARNING @line ~411... UNDEFINED Variable name!!!");
...
//                                                        ComplexObject co2=new ComplexObject();
//                                                        co2.setObjectName(co1.getObjectName());
//                                                        co2.setObjectType(new QName(co1.getObjectType().getNamespaceURI(), co1.getObjectType().getLocalPart().replace("[]", ""),  co1.getObjectType().getPrefix()));
...
//                                                }
                                                ...
                                                if (schElemOfType != null && schElemOfType.getMaxOccurs() > 1) {
                                                    try {
                                                        if (!((ComplexObject) co1.getHasComplexObjects().get(0)).getObjectName().getLocalPart().equals(co1.getObjectType().getLocalPart().replace("[]", ""))) {
                                                            ...
                                                            dummyInputOrOutputComplexObject.getHasComplexObjects().add(coArrayCO);
                                                        } else {
                                    ...
                                    } else if (newObj1.getClass().getName().contains("org.apache.ws.commons.schema.XmlSchemaAny")) {
                                        //EINAI XmlSchemaAny
                                    ...
                                    } else if (newObj1.getClass().getName().contains("org.apache.ws.commons.schema.XmlSchemaChoice")) {
                                        //EINAI XmlSchemaAny
                                        try {
                                            System.out.println();
                                        ...
                                        if (co1 != null) {
                                            for (int i = 0; i < co1.getHasComplexObjects().size(); i++) {
                                                dummyInputOrOutputComplexObject.getHasComplexObjects().add(co1.getHasComplexObjects().get(i));
                                            }
                                            for (int i = 0; i < co1.getHasNativeObjects().size(); i++) {
                                                dummyInputOrOutputComplexObject.getHasNativeObjects().add(co1.getHasNativeObjects().get(i));
                                            }
                                        } else {
                                            System.out.println();
                                        }
                                ...
                                if (ct.getContentModel() != null &&
                                        ct.getContentModel().getClass().getName().equals("org.apache.ws.commons.schema.XmlSchemaComplexContent")) {
                                    try {
                                        ComplexTypesParser.parseComplexContent(service,
                                                (org.apache.ws.commons.schema.XmlSchemaComplexContent) ct.getContentModel(),
                                    ...
                                    System.out.println("a");
                                        ...
                                        ct.getContentModel().getClass().getName().equals("org.apache.ws.commons.schema.XmlSchemaSimpleContent")) {
                                    XmlSchemaSimpleContent simpleContent = (XmlSchemaSimpleContent) ct.getContentModel();
                                    SimpleTypesParser.parseSimpleContent(service, simpleContent, dummyInputOrOutputComplexObject, theDefinition);
                                } else {
                                    System.out.println();
                                }
                            ...
                            ComplexObject unionCO = SimpleTypesParser.parseSimpleType(el, null, no, theDefinition, service);
                            if (unionCO != null) {
                                if (el.getMaxOccurs() > 1) {
                                    ComplexObject noArrayCO = new ComplexObject();
                                    noArrayCO.setObjectName(no.getObjectName());
                                    noArrayCO.setObjectType(new QName(no.getObjectType().getNamespaceURI(), no.getObjectType().getLocalPart() + "[]", no.getObjectType().getPrefix()));
                                    noArrayCO.setIsArrayType(true);
                                    noArrayCO.getHasComplexObjects().add(unionCO);
                                    dummyInputOrOutputComplexObject.getHasComplexObjects().add(noArrayCO);
                                ...
                                if (no != null && no.getAdditionalInfo() != null && no.getAdditionalInfo().contains("isListType")) {
                                    if (el.getMaxOccurs() > 1) {
                                        ComplexObject noArrayCO = new ComplexObject();
                                        noArrayCO.setObjectName(no.getObjectName());
                                        noArrayCO.setObjectType(new QName(no.getObjectType().getNamespaceURI(), no.getObjectType().getLocalPart() + "[][]", no.getObjectType().getPrefix()));
                                        ...
                                        noArrayCO_ListNO.setObjectType(new QName(no.getObjectType().getNamespaceURI(), no.getObjectType().getLocalPart() + "[]", no.getObjectType().getPrefix()));
                                        noArrayCO_ListNO.setIsArrayType(true);
                        ...
                        //Replace the modified direction of Message with the Original created from Axis2
                        if (oper.getClass().getName().contains("OutOnlyAxisOperation")) {
                            if (msg.getDirection().equals("in")) {
...
//                    }
    ...
    private static Vector parseSoapHeadersOfOperation(AxisService service, AxisMessage msg, ParsedWSDLDefinition theDefinition) {
        ...
        while (iter1.hasNext()) {
            ...
            try {
                ...
                //Prepei na vrw to element me QName: sh.getElement() mesa sta types tou WSDL kai na to valw san Native i Complex Object
                ...
                //Den kserw omws kata poso fernei panta to Axis swsta tin pliroforia gia to an einai required to header...
                headerCO.setIsOptional(!sh.isRequired());

                XmlSchemaType xmlSchemaType1 = ParsingUtils.parseWSDLschemasInOrderToFindTheSpecificXMLSchemaType(service, sh.getElement());
                if (xmlSchemaType1 == null) {
                    xmlSchemaType1 = ParsingUtils.parseWSDLschemasInOrderToFindTheSpecificXMLSchemaElement(service, sh.getElement());
                }
    ...
    private static Object getFaultMsgAsComplexObject(AxisService service, AxisMessage msg, ParsedWSDLDefinition theDefinition) {
        try {
            if (msg == null) {
                return null;
            }
            //Get ELEMENT FROM the Service SCHEMA
            org.apache.ws.commons.schema.XmlSchemaElement schElemOfType = service.getSchemaElement(msg.getElementQName());
    ...
    static private void getAllDependencies(ParsedWSDLDefinition theDefinition, org.apache.axis2.description.AxisService service) {
        ...
        for (int i = 0; i < theDefinition.getXsdDependencies().size(); i++) {
            if (((String) theDefinition.getXsdDependencies().get(i)).contains("../")) {
                while (((String) theDefinition.getXsdDependencies().get(i)).contains("../")) {
                    theDefinition.getXsdDependencies().setElementAt(((String) theDefinition.getXsdDependencies().get(i)).replace("../", ""), i);
                }
                theDefinition.getXsdDependencies().setElementAt("./" + ((String) theDefinition.getXsdDependencies().get(i)), i);
            }
        }
    }

...
public class SimpleTypesParser {
	...
	public static ComplexObject parseSimpleType(XmlSchemaElement schElemOfType, XmlSchemaType xmlSchemaType,
		...
		if (schElemOfType != null) {
			...
			if (schElemOfType.getMaxOccurs() > 1) {
				...
				// arrayCOforNO=getArrayCoForNo(schElemOfType, xmlSchemaType,
				// no, theDefinition);
				// return;
			}
			...
			if (schElemOfType.getSchemaType() != null) {
				try {
					org.apache.ws.commons.schema.XmlSchemaSimpleType st = (org.apache.ws.commons.schema.XmlSchemaSimpleType) schElemOfType
							.getSchemaType();
	...
	public static void parseSimpleContent(AxisService service, XmlSchemaSimpleContent simpleContent, ComplexObject co,
		...
		if (simpleContent.getContent().getClass().getName()
			...
			org.apache.ws.commons.schema.XmlSchemaObjectCollection ctCollection = (org.apache.ws.commons.schema.XmlSchemaObjectCollection) restriction
					.getAttributes();
			...
			try {
				org.apache.ws.commons.schema.XmlSchemaSimpleContentExtension extension = (org.apache.ws.commons.schema.XmlSchemaSimpleContentExtension) simpleContent
						.getContent();
				...
				// Parse ta ypoloipa objects tou co
				org.apache.ws.commons.schema.XmlSchemaObjectCollection ctCollection = (org.apache.ws.commons.schema.XmlSchemaObjectCollection) extension
						.getAttributes();
				Iterator containedObjectsIter = ctCollection.getIterator();
				while (containedObjectsIter.hasNext()) {
					Object obj = containedObjectsIter.next();

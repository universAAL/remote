...
public class Queries {
    ...
    protected static final String AUXBAGPROP = ContextHistoryProfileAgent.CONTEXT_HISTORY_HTL_IMPL_NAMESPACE + "auxBagProp";
    ...
    protected static final String ADDTOSPACE = "INSERT { ?p <"
	    + ARGTYPE 
	    + "> <" 
	    + ARG2 
	    + "> . " + ARGTURTLE + " } WHERE {<" 
    ...
    protected static final String ADDTOSPACE2 = "INSERT { ?p <"
        + ARG2 
        + ">} WHERE {<" 
        + ARG1 
        + "> <" 

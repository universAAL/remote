...
public class ParsingUtils {
    ...
    public static XmlSchemaType parseWSDLschemasInOrderToFindTheSpecificXMLSchemaType(AxisService service, QName schemaTypeName) {
    ...
    public static XmlSchemaType parseWSDLschemasInOrderToFindTheSpecificXMLSchemaElement(AxisService service, QName schemaTypeName) {
        if(schemaTypeName==null){
            //-System.out.prinln("NULL!");
            return null;
        }
        ...
        for(int i=0;i<schemasList.size();i++){
             ...
             if(schemaElement!=null){
                 ...
                 /*
                 XmlSchemaObject obj1=searchSchemaIncludesForAttribute_ITERATIVE(s, schemaTypeName);
                 if(obj1!=null){
                    System.out.println();
                 }else{
                     System.out.println();
...
/*
    ...
    private static boolean schemaHasAlreadyBeenParsed(String schemaName){
        if(parsedSchemasForAttSearch_ITERATIVE==null||schemaName==null)return false;

        for(int i=0;i<parsedSchemasForAttSearch_ITERATIVE.size();i++){
            if(schemaName.equals(parsedSchemasForAttSearch_ITERATIVE.get(i))){//Na ftiaksw ton elegxo
                return true;
            }
        }
        return false;
...
*/
    ...
    public static XmlSchemaAttribute parseWSDLschemasInOrderToFindTheSpecificXMLSchemaAttribute(AxisService service, QName schemaTypeName) {
        if(schemaTypeName==null){
            //-System.out.prinln("NULL!");
            return null;
        }
        ...
        for(int i=0;i<schemasList.size();i++){
             ...
             if(attsCollectionTable==null)continue;
             ...
             if(schemaAttributeObject!=null){
                ...
                schemaAttributeObject=searchSchemaIncludesForAttribute_ITERATIVE_10_IterationsMax(s, schemaTypeName, 0);
                if(schemaAttributeObject!=null){
                    if(schemaAttributeObject.getClass().getName().contains("XmlSchemaAttribute")){
                        //break;
                        return (XmlSchemaAttribute)schemaAttributeObject;
        ...
        /*
        try{
            XmlSchemaAttribute schemaAttribute=(XmlSchemaAttribute)schemaAttributeObject;
            if(schemaAttribute.getSchemaType()!=null){
                System.out.println();
                return schemaAttribute.getSchemaType();
            }else if(schemaAttribute.getSchemaTypeName()!=null){
                XmlSchemaType xmlSchemaType=parseWSDLschemasInOrderToFindTheSpecificXMLSchemaType(service, schemaAttribute.getSchemaTypeName());
                if(xmlSchemaType==null){
                    xmlSchemaType=parseWSDLschemasInOrderToFindTheSpecificXMLSchemaElement(service, schemaAttribute.getSchemaTypeName());
                }
                if(xmlSchemaType!=null){
    ...
    public static XmlSchemaGroup parseWSDLschemasInOrderToFindTheSpecificXMLSchemaGroup(AxisService service, QName schemaTypeName) {
        if(schemaTypeName==null){
            //-System.out.prinln("NULL!");
            return null;
        }
        ...
        for(int i=0;i<schemasList.size();i++){
             ...
             if(groupsCollectionTable==null)continue;
    ...
    public static XmlSchemaAttributeGroup parseWSDLschemasInOrderToFindTheSpecificXMLSchemaAttributeGroup(AxisService service, QName schemaTypeName) {
        if(schemaTypeName==null){
            //-System.out.prinln("NULL!");
            return null;
        }
        ...
        for(int i=0;i<schemasList.size();i++){
             ...
             if(schemaAttributeGroupObject!=null){
                ...
                System.out.println();
                schemaAttributeGroupObject=searchSchemaIncludesForAttributeGroup_ITERATIVE_10_IterationsMax(s, schemaTypeName, 0);
                if(schemaAttributeGroupObject!=null){
                    if(schemaAttributeGroupObject.getClass().getName().contains("XmlSchemaAttributeGroup")){
                        //break;
                        return (XmlSchemaAttributeGroup)schemaAttributeGroupObject;
    ...
    public static XmlSchemaObject searchSchemaIncludesForGroup_ITERATIVE_10_IterationsMax(org.apache.ws.commons.schema.XmlSchema initialSchema, QName schemaTypeName, int iterationsCount){
        ...
        */
        ...
        if(includedSchemas==null)return null;
        ...
        while(iter1.hasNext()){
            ...
            if(theIncludedOrImportedSchema==null)continue;
            ...
            if(schemaGroupObject!=null){
               ...
               return schemaGroupObject;
                ...
                iterationsCount++;
                XmlSchemaObject newSchemaGroupObject=
                        searchSchemaIncludesForGroup_ITERATIVE_10_IterationsMax(theIncludedOrImportedSchema, schemaTypeName, iterationsCount);
    ...
    public static XmlSchemaObject searchSchemaIncludesForAttributeGroup_ITERATIVE_10_IterationsMax(org.apache.ws.commons.schema.XmlSchema initialSchema, QName schemaTypeName, int iterationsCount){
        ...
        while(iter1.hasNext()){
            ...
            if(schemaGroupObject!=null){
               ...
               return schemaGroupObject;
                ...
                iterationsCount++;
                XmlSchemaObject newSchemaGroupObject=
                        searchSchemaIncludesForAttributeGroup_ITERATIVE_10_IterationsMax(theIncludedOrImportedSchema, schemaTypeName, iterationsCount);
                if(newSchemaGroupObject!=null){
                    return newSchemaGroupObject;
                }
            }
    ...
    public static XmlSchemaObject searchSchemaIncludesForAttribute_ITERATIVE_10_IterationsMax(org.apache.ws.commons.schema.XmlSchema initialSchema, QName schemaTypeName, int iterationsCount){
        ...
        while(iter1.hasNext()){
            ...
            if(schemaAttributeObject!=null){
               ...
               return schemaAttributeObject;
                ...
                iterationsCount++;
                XmlSchemaObject newSchemaAttributeObject=
                        searchSchemaIncludesForAttribute_ITERATIVE_10_IterationsMax(theIncludedOrImportedSchema, schemaTypeName, iterationsCount);
    ...
    public static void checkIfCOisAnyObjectType(ComplexObject co){
        ...
        if(co.getObjectType()==null){
            ...
            //An ti skapoularei kai exei akoma NULL objectType dwse onoma sto objectType
            if(co.getObjectType()==null){
            ...
            if(co.getHasComplexObjects()==null&&co.getHasComplexObjects()==null){
                co.setObjectType(new QName("Object"));
            }else if(co.getHasComplexObjects()!=null&&co.getHasComplexObjects().size()==1){
                ComplexObject co1=(ComplexObject)co.getHasComplexObjects().get(0);
                if(co1.getObjectName()!=null&&co1.getObjectType()!=null){
                    if(co1.getObjectName().getLocalPart().equals("any")&&
                            co1.getObjectType().getLocalPart().equals("Object")){
    ...
    public static Object tryToFindAndParseAttributeForSpecificObject(ParsedWSDLDefinition theDefinition, AxisService service, QName objectName){
        XmlSchemaAttribute att = ParsingUtils.parseWSDLschemasInOrderToFindTheSpecificXMLSchemaAttribute(service, objectName);
    ...
    public static ComplexObject tryToFindAndParseGroupForSpecificObject(ParsedWSDLDefinition theDefinition, AxisService service, QName objectName){
    ...
    public static ComplexObject tryToFindAndParseAttributeGroupForSpecificObject(ParsedWSDLDefinition theDefinition, AxisService service, QName objectName){
        XmlSchemaAttributeGroup group = ParsingUtils.parseWSDLschemasInOrderToFindTheSpecificXMLSchemaAttributeGroup(service, objectName);
        if(group!=null){
            System.out.println("");
    ...
    /*
    static HashMap updatedComplexTypes;
    public static void updateAllComplexObjectsOfTheCOsHashMap() {
        if(ComplexTypesParser.parsedComplexObjectsHashmap==null||ComplexTypesParser.parsedComplexObjectsHashmap.values()==null)
            return;

        updatedComplexTypes=new HashMap();
        Iterator iter=ComplexTypesParser.parsedComplexObjectsHashmap.values().iterator();
        while(iter.hasNext()){
            try{
                ComplexObject co=(ComplexObject)iter.next();
                ...
                for(int i=0;i<co.getHasComplexObjects().size();i++){
                    ...
                    QName co1Type = co1.getObjectType();
                    if(co1Type.getLocalPart().contains("NutritionalPlans")){
                        System.out.println();
                    }
                    if(updatedComplexTypes.containsKey(co1Type)){
                        System.out.println();
                        QName co1Name=
                                        new QName(co1.getObjectName().getNamespaceURI(), co1.getObjectName().getLocalPart(), co1.getObjectName().getPrefix());
                        ComplexObject newCO1=(ComplexObject)updatedComplexTypes.get(co1Type);
                        co1=newCO1;
                        co1.setObjectName(co1Name);
                        //updatedComplexTypes.put(co2Type, co2);
                        System.out.println();
                    }else{
                        if(ComplexTypesParser.parsedComplexObjectsHashmap.containsKey(co1Type)){
                            QName co1Name=
                                    new QName(co1.getObjectName().getNamespaceURI(), co1.getObjectName().getLocalPart(), co1.getObjectName().getPrefix());
                            ComplexObject newCO1=(ComplexObject)ComplexTypesParser.parsedComplexObjectsHashmap.get(co1Type);
                            co1=newCO1;
                            co1.setObjectName(co1Name);
                            System.out.println();
                            updatedComplexTypes.put(co1Type, co1);
    ...
    private static void updateAllComplexObjectsOfTheCO_ITERATIVE(ComplexObject co1) {
        if(co1.getHasComplexObjects()==null)return;
        Iterator iter1=co1.getHasComplexObjects().iterator();
        while(iter1.hasNext()){
            try{
                ComplexObject co2=(ComplexObject)iter1.next();
                QName co2Type=co2.getObjectType();
                if(co2Type.getLocalPart().contains("NutritionalPlans")){
                    System.out.println();
                }
                if(updatedComplexTypes.containsKey(co2Type)){
                    System.out.println();
                    QName co2Name=
                                    new QName(co2.getObjectName().getNamespaceURI(), co2.getObjectName().getLocalPart(), co2.getObjectName().getPrefix());
                    ComplexObject newCO2=(ComplexObject)updatedComplexTypes.get(co2Type);
                    co2=newCO2;
                    co2.setObjectName(co2Name);
                    //updatedComplexTypes.put(co2Type, co2);
                    System.out.println();
                }else{
                    if(ComplexTypesParser.parsedComplexObjectsHashmap.containsKey(co2Type)){
                        QName co2Name=
                                    new QName(co2.getObjectName().getNamespaceURI(), co2.getObjectName().getLocalPart(), co2.getObjectName().getPrefix());
                        ComplexObject newCO2=(ComplexObject)ComplexTypesParser.parsedComplexObjectsHashmap.get(co2Type);
                        co2=newCO2;
                        co2.setObjectName(co2Name);
                        updatedComplexTypes.put(co2Type, co2);
                        System.out.println();

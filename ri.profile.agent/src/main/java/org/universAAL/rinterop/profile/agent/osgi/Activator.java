...
public class Activator implements BundleActivator, ServiceListener {
	...
	public void start(BundleContext context) throws Exception {
		...
		// String userURI =
		// "http://ontology.universAAL.org/ContextHistoryHTLImpl.owl#dummyUser";
		...
		Object httpServiceObj = moduleContext.getContainer().fetchSharedObject(moduleContext,
		...
		deployManager = (DeployManagerService) moduleContext.getContainer().fetchSharedObject(moduleContext,

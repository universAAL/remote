...
/**
 * Uses to execute the WEB Service command on the AccessControlContext for the logged user.
 * 
...
//      AccessController.doPrivileged(new Exe(command), SessionContext.getSessionContext().getACC());
//    } else {
      command.run();
//    }
  }

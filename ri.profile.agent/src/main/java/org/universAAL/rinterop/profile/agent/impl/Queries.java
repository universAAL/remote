...
public class Queries {
	...
	protected static final String AUXBAG = ContextHistoryProfileAgent.CONTEXT_HISTORY_HTL_IMPL_NAMESPACE + "auxBag";
	protected static final String AUXBAGPROP = ContextHistoryProfileAgent.CONTEXT_HISTORY_HTL_IMPL_NAMESPACE
			+ "auxBagProp";
	...
	protected static final String ADDTOSPACE = "INSERT { ?p <" + ARGTYPE + "> <" + ARG2 + "> . " + ARGTURTLE
			+ " } WHERE {<" + ARG1 + "> <" + Profilable.PROP_HAS_PROFILE + "> ?p}";

	protected static final String ADDTOSPACE2 = "INSERT { ?p <" + ARG2 + ">} WHERE {<" + ARG1 + "> <"
	...
	protected static final String Q_GET_PRF_OF_SPACE = "DESCRIBE ?p WHERE {<" + ARG1 + "> <"
			+ Profilable.PROP_HAS_PROFILE + "> ?p}";

	protected static final String Q_GET_PRF_OF_SPACE_XTRA = "CONSTRUCT { ?p a ?t } WHERE {<" + ARG1 + "> <"

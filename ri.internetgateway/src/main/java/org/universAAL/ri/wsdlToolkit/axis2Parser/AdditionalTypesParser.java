...
public class AdditionalTypesParser {
	...
	public static ComplexObject parseXmlSchemaAttributeGroup_NEW(AxisService service, XmlSchemaAttributeGroup group,
		...
		while (iter1.hasNext()) {
			...
			if (obj1.getClass().getName().contains("XmlSchemaAttributeGroupRef")) {
				...
				Object nativeOrComplexObject = AdditionalTypesParser.parseXmlSchemaAttribute((XmlSchemaAttribute) obj1,
	...
	public static void parseXmlSchemaAttributeGroupRefElement(AxisService service, XmlSchemaAttributeGroupRef xsgr,
		...
		ComplexObject co1 = ParsingUtils.tryToFindAndParseAttributeGroupForSpecificObject(theDefinition, service,
				xsgr.getRefName());
		if (co1 != null) {
			for (int i = 0; i < co1.getHasComplexObjects().size(); i++) {
				co.getHasComplexObjects().add(co1.getHasComplexObjects().get(i));
	...
	public static void parseXmlSchemaElement(AxisService service, Object newObj1, ComplexObject co,
		...
		if (newSimpleOrComplexObjectElement.getSchemaType() != null) {
			...
			if (newSimpleOrComplexObjectElement.getSchemaType().getClass().toString()
				...
				ComplexObject co1 = new ComplexObject();
				ComplexTypesParser.parseComplexType(service, newSimpleOrComplexObjectElement, null, co1, theDefinition,
						false);
				typeParsed = true;
					...
					if (newSimpleOrComplexObjectElement.getRefName() == null) {
						...
						if (newSimpleOrComplexObjectElement.getMaxOccurs() > 1) {
							...
							if (newSimpleOrComplexObjectElement.getSchemaType() == null) {
								...
								ComplexTypesParser.parseComplexType(service, newSimpleOrComplexObjectElement, null, co1,
										theDefinition, false);
	...
	public static void parseXmlSchemaAllType(AxisService service, XmlSchemaAll xsa, ComplexObject co,
		...
		while (iter1.hasNext()) {
			...
			if (newSimpleOrComplexObjectElement.getName() != null
					&& newSimpleOrComplexObjectElement.getName().equals("FullName")) {
						...
						if (newSimpleOrComplexObjectElement.getRefName() != null) {
							org.apache.ws.commons.schema.XmlSchemaType xmlSchemaType = ParsingUtils
									.parseWSDLschemasInOrderToFindTheSpecificXMLSchemaType(service,
											newSimpleOrComplexObjectElement.getRefName());
							if (xmlSchemaType == null) {
								xmlSchemaType = ParsingUtils.parseWSDLschemasInOrderToFindTheSpecificXMLSchemaElement(
							...
							if (xmlSchemaType.getClass().toString()
								...
								ComplexTypesParser.parseComplexType(service, null, xmlSchemaType, co1, theDefinition,
										false);
								if (newSimpleOrComplexObjectElement.getMinOccurs() == 0
										|| newSimpleOrComplexObjectElement.isNillable()) {
									co1.setIsOptional(true);
	...
	public static void parseXMLSchemaChoiceElement(AxisService service,
			org.apache.ws.commons.schema.XmlSchemaChoice choiceElement, ComplexObject choiceCO,
		...
		if (col1 != null) {
			...
			while (iter1.hasNext()) {
				...
				if (newObj2 != null
						&& newObj2.getClass().getName().contains("org.apache.ws.commons.schema.XmlSchemaElement")) {
					...
					if (newSimpleOrComplexObjectElement.getSchemaType() != null) {
						...
						if (newSimpleOrComplexObjectElement.getSchemaType().getClass().toString()
							...
							if (unionCO != null) {
								 ...
								 * getMaxOccurs ()>1){ ComplexObject
								 * noArrayCO=new ComplexObject();
								 *
								 * noArrayCO.setObjectName(no1.getObjectName());
								 * noArrayCO.setObjectType(new
						...
						if (newSimpleOrComplexObjectElement.getSchemaType() == null) {
							...
							if (newSimpleOrComplexObjectElement.getSchemaTypeName() != null) {
								theSchemaType = ParsingUtils.parseWSDLschemasInOrderToFindTheSpecificXMLSchemaType(
						...
						if (theSchemaType.getClass().toString()
							...
							ComplexObject unionCO = SimpleTypesParser.parseSimpleType(null, theSchemaType, no1,
									theDefinition, service);
							if (unionCO == null) {
								if (newSimpleOrComplexObjectElement.getMinOccurs() == 0
										|| newSimpleOrComplexObjectElement.isNillable()) {
					...
					while (iter11.hasNext()) {
						...
						if (newObj21 != null && newObj21.getClass().getName()
								.contains("org.apache.ws.commons.schema.XmlSchemaElement")) {
							...
							if (newSimpleOrComplexObjectElement.getSchemaType() != null) {
								...
								schemaType = ParsingUtils.parseWSDLschemasInOrderToFindTheSpecificXMLSchemaType(service,
										newSimpleOrComplexObjectElement.getRefName());
								if (schemaType == null) {
									schemaType = ParsingUtils.parseWSDLschemasInOrderToFindTheSpecificXMLSchemaElement(
											service, newSimpleOrComplexObjectElement.getRefName());
								}
							...
							if (schemaType != null) {
								...
								boolean typeParsed = false;
								if (schemaType.getClass().toString()
										.contains("org.apache.ws.commons.schema.XmlSchemaSimpleType")) {
									NativeObject no1 = new NativeObject();
									ComplexObject unionCO = SimpleTypesParser.parseSimpleType(
											newSimpleOrComplexObjectElement, null, no1, theDefinition, service);
									if (newSimpleOrComplexObjectElement.getMinOccurs() == 0
											|| newSimpleOrComplexObjectElement.isNillable()) {
										no1.setIsOptional(true);
									}
									if (unionCO != null) {
										...
										if (no1 != null && no1.getAdditionalInfo() != null
											...
											if (newSimpleOrComplexObjectElement.getMaxOccurs() > 1) {
												...
												noArrayCO_ListNO.setObjectName(no1.getObjectName());
												noArrayCO_ListNO
														.setObjectType(new QName(no1.getObjectType().getNamespaceURI(),
																no1.getObjectType().getLocalPart() + "[]",
																no1.getObjectType().getPrefix()));
												noArrayCO_ListNO.setIsArrayType(true);
												noArrayCO_ListNO.setIsOptional(no1.isIsOptional());
								...
								} else if (schemaType.getClass().toString()
										.contains("org.apache.ws.commons.schema.XmlSchemaComplexType")) {
									ComplexObject co1 = new ComplexObject();
									// edw prepei na mpei elegxos an to
									...
									// gia na apofygw to StackOverflowError
									if (newSimpleOrComplexObjectElement.getSchemaType() != null) {
										ComplexTypesParser.parseComplexType(service, newSimpleOrComplexObjectElement,
												null, co1, theDefinition, calledFromAbstractTypeParser);
										sequenceCO.getHasComplexObjects().add(co1);
									} else {
										co1.setObjectName(schemaType.getQName());
										co1.setObjectType(schemaType.getQName());
										ComplexTypesParser.parseComplexType(service, null, schemaType, co1,
												theDefinition, calledFromAbstractTypeParser);
										if (newSimpleOrComplexObjectElement != null
												&& (newSimpleOrComplexObjectElement.getMinOccurs() == 0
														|| newSimpleOrComplexObjectElement.isNillable())) {
						...
						} else if (newObj21 != null && newObj21.getClass().getName()
	...
	public static void parseXMLSchemaSimpleTypeUnionElement(AxisService service,
			org.apache.ws.commons.schema.XmlSchemaSimpleTypeUnion unionElement, ComplexObject unionCO,
			ParsedWSDLDefinition theDefinition, boolean calledFromAbstractTypeParser) {
		...
		if (memberTypeNames == null || memberTypeNames.length == 0) {
			...
			while (iter1.hasNext()) {
				...
				if (obj != null && obj.getClass().getName().contains("XmlSchemaSimpleType")) {
					...
					ComplexObject unionCO2 = SimpleTypesParser.parseSimpleType(null, xmlSchemaSimpleType, no1,
							theDefinition, service);
					if (unionCO2 == null) {
			...
			for (int i = 0; i < memberTypeNames.length; i++) {
				...
				XmlSchemaType xmlSchemaType = ParsingUtils
						.parseWSDLschemasInOrderToFindTheSpecificXMLSchemaType(service, memberQName);
				if (xmlSchemaType == null) {
				...
				if (xmlSchemaType == null) {
					...
					if (xmlSchemaType.getClass().getName().contains("XmlSchemaSimpleType")) {
						...
						ComplexObject newCO = SimpleTypesParser.parseSimpleType(null, xmlSchemaType, no1, theDefinition,
								service);
	...
	public static Object parseXmlSchemaAttribute(XmlSchemaAttribute xmlSchemaAttribute, AxisService service,
			ParsedWSDLDefinition theDefinition) {
		...
		if (xmlSchemaAttribute.getSchemaTypeName() != null
				&& xmlSchemaAttribute.getSchemaTypeName().getNamespaceURI() != null && xmlSchemaAttribute
						.getSchemaTypeName().getNamespaceURI().contains("http://www.w3.org/2001/XMLSchema")) {
			...
			// FIND THE TYPE!
			// parse it...
			XmlSchemaType xmlSchemaType1 = ParsingUtils.parseWSDLschemasInOrderToFindTheSpecificXMLSchemaType(service,
					xmlSchemaAttribute.getSchemaTypeName());
			...
			if (xmlSchemaType1.getClass().getName().contains("XmlSchemaComplexType")) {
				...
				ComplexObject unionCO = SimpleTypesParser.parseSimpleType(null, xmlSchemaType1, no1, theDefinition,
						service);
				if (unionCO == null) {
	...
	public static void parseAllExtensionTypesOfTheAbstractType(AxisService service, ComplexObject co,
			QName abstractTypeName, ParsedWSDLDefinition theDefinition) {
			...
			while (typesIter.hasNext()) {
				...
				if (type.getClass().getName().contains("org.apache.ws.commons.schema.XmlSchemaComplexType")) {
					...
					if (type1.getContentModel() != null && type1.getContentModel().getContent() != null
							&& type1.getContentModel().getContent().getClass().getName()
									.contains("XmlSchemaComplexContentExtension")) {
						...
						if (extensionContent.getBaseTypeName().equals(abstractTypeName)) {
							...
							XmlSchemaType xmlSchemaType1 = ParsingUtils
									.parseWSDLschemasInOrderToFindTheSpecificXMLSchemaType(service, type1.getQName());
							if (xmlSchemaType1 == null) {
								xmlSchemaType1 = ParsingUtils.parseWSDLschemasInOrderToFindTheSpecificXMLSchemaElement(
										service, type1.getQName());
							}

							if (xmlSchemaType1.getClass().getName().contains("XmlSchemaComplexType")) {
								ComplexTypesParser.parseComplexType(service, null, xmlSchemaType1, co1, theDefinition,
										true);
	...
	public static void parseArrayType(AxisService service, ComplexObject arrayCO, QName qName,
			ParsedWSDLDefinition theDefinition, org.apache.ws.commons.schema.XmlSchemaType inXmlSchemaType,
		...
		if (xmlSchemaType != null) {
			try {
				...
				if (xmlSchemaType.getClass().getName().contains("org.apache.ws.commons.schema.XmlSchemaSimpleType")) {
					...
					ComplexObject unionCO2 = SimpleTypesParser.parseSimpleType(null, xmlSchemaType, containedNO,
							theDefinition, service);
					if (unionCO2 == null) {
						if ((el1 != null && el1.getMaxOccurs() > 1) || (containedNO.getAdditionalInfo() != null
								&& containedNO.getAdditionalInfo().contains("isListType"))) {
							ComplexObject noArrayCO = new ComplexObject();
							noArrayCO.setObjectName(containedNO.getObjectName());
							noArrayCO.setObjectType(new QName(containedNO.getObjectType().getNamespaceURI(),
				...
				if (ct.getContentModel() == null) {
					...
					if (ct.getParticle() != null) {
						if (ct.getParticle().getClass().getName()
						...
						} else if (ct.getParticle().getClass().getName()
					...
					if (ct.getContentModel().getClass().getName().contains("XmlSchemaSimpleContent")) {
						...
						if (containedCO.getObjectName() == null
								|| containedCO.getObjectName().getLocalPart().equals("Error")) {
							System.out.println();
						...
						if (cc.getContent().getClass().getName()
							...
							ComplexTypesParser.parseComplexContent(service, cc, containedCO, theDefinition,
									calledFromAbstractTypeParser, containedCO.getObjectType());
						...
						} else if (cc.getContent().getClass().getName()
					...
					while (iter1.hasNext()) {
						...
						if (abstractElem instanceof org.apache.ws.commons.schema.XmlSchemaElement) {
							...
							if (elem1 != null) {
								...
								if (theSchemaType == null) {
									Object res123 = ParsingUtils.tryToFindAndParseAttributeForSpecificObject(
											theDefinition, service, elem1.getRefName());
									if (res123 != null) {
										if (res123.getClass().getName().contains("NativeObject")) {
								...
								if (theSchemaType.getClass().toString()
									...
									ComplexTypesParser.parseComplexType(service, null, theSchemaType, co1,
											theDefinition, calledFromAbstractTypeParser);
							...
							if (elem1 != null) {
								if (elem1.getSchemaType() != null) {
									if (elem1.getSchemaType().getClass().toString()
											.contains("org.apache.ws.commons.schema.XmlSchemaComplexType")) {
										ComplexObject co1 = new ComplexObject();
										if (elem1.getQName() != null) {
										...
										ComplexTypesParser.parseComplexType(service, null, elem1.getSchemaType(), co1,
												theDefinition, calledFromAbstractTypeParser);
										...
										containedCO.getHasComplexObjects().add(co1);
										// co.isArrayType=true;
									} else if (elem1.getSchemaType().getClass().toString()
											.contains("org.apache.ws.commons.schema.XmlSchemaSimpleType")) {
										NativeObject no1 = new NativeObject();
									...
									// theDefinition.getContainingErrors().add("ERROR
									// - WARNING @ line ~663!!!... mpike edw...
									// check ti ginetai edw...");
									...
									if (arrayCO.getObjectType() != null) {
										...
										XmlSchemaType xmlSchemaType1 = ParsingUtils
												.parseWSDLschemasInOrderToFindTheSpecificXMLSchemaType(service, qName1);
										if (xmlSchemaType1 == null) {
										...
										if (xmlSchemaType1.getClass().getName().contains("XmlSchemaComplexType")) {
											...
											ComplexTypesParser.parseComplexType(service, null, xmlSchemaType1, co1,
													theDefinition, calledFromAbstractTypeParser);
							...
							parseXMLSchemaChoiceElement(service, elem1, co1, theDefinition,
									calledFromAbstractTypeParser);
	...
	public static ComplexObject getArrayCoForNo(XmlSchemaElement schElemOfType, XmlSchemaType xmlSchemaType,
			NativeObject no, ParsedWSDLDefinition theDefinition) {

...
public class WSDL_XSD_SchemaToolkit {
    ...
    /*
    public static boolean nodeExistsInSchema(String nameOfNode, javax.wsdl.extensions.schema.Schema theInputXSDSchema){
        boolean nodeExists=false;
        
        if(nameOfNode==null||theInputXSDSchema==null)return false;
        
        //-System.out.println("### Looking for node: '"+nameOfNode+"' in file: '"+theInputXSDSchema.getDocumentBaseURI()+"'");
        ...
        if(theInputXSDSchema!=null){                      
            org.w3c.dom.Element impSchElem=theInputXSDSchema.getElement();
                ...
                for(int i=0;i<elementNodesList.getLength();i++){
                    ...
                    if(n.hasAttributes()&&n.getAttributes().getNamedItem("name")!=null){
                        if(n.getAttributes().getNamedItem("name").getNodeValue().equals(theNodeNameAttValue)){   
                            //-System.out.println("NODE EXISTS!: ELEMENT");
                            return true;                            
                        }
                    }
                }                
            ...
            if(complexTypeNodesList!=null){
                for(int i=0;i<complexTypeNodesList.getLength();i++){
                    ...
                    if(n.hasAttributes()&&n.getAttributes().getNamedItem("name")!=null){
                        if(n.getAttributes().getNamedItem("name").getNodeValue().equals(theNodeNameAttValue)){ 
                            //-System.out.println("NODE EXISTS!: COMPLEX TYPE");
                            return true;
                        }
                    }
                }                
            ...
            if(simpleTypeNodesList!=null){
                for(int i=0;i<simpleTypeNodesList.getLength();i++){
                    ...
                    if(n.hasAttributes()&&n.getAttributes().getNamedItem("name")!=null){
                        if(n.getAttributes().getNamedItem("name").getNodeValue().equals(theNodeNameAttValue)){ 
                            //-System.out.println("NODE EXISTS!: SIMPLE TYPE");
                            return true;
                        }
                    }
                }                
            ...
            if(groupTypeNodesList!=null){
                for(int i=0;i<groupTypeNodesList.getLength();i++){
                    ...
                    if(n.hasAttributes()&&n.getAttributes().getNamedItem("name")!=null){
                        ...
                        if(n.getAttributes().getNamedItem("name").getNodeValue().equals(theNodeNameAttValue)){   
                            //-System.out.println("NODE EXISTS!: GROUP");                           
                            return true;                               
                        }
                    }
                }                
            ...
            if(includesList!=null){
                ...
                while(includesIter.hasNext()){
                    ...
                    Node n1=getNodeOfType(nameOfNode,includedSchema);
                    if(n1!=null)return true;
                }
            }
            
            Map importsMap=theInputXSDSchema.getImports();
            if(importsMap!=null){
        ...
        //-System.out.println("Node DOES NOT Exist here...");
        return nodeExists;
    ...
    public static Node getNodeOfType_ITERATIVE(String nameOfNode, javax.wsdl.extensions.schema.Schema importedOrIncludedSchema,
            String previousXSDURI, Schema theSchemaOfTheWSDL){
        
        if(nameOfNode==null||importedOrIncludedSchema==null)return null;
        ...
        //-System.out.println("### ### ITERATIVE Looking for Node:  "+nameOfNode +"  in: "+importedOrIncludedSchema.getDocumentBaseURI());
                ...
                while(includesIter.hasNext()){
                    ...
                    if(includedSchema.getDocumentBaseURI()!=null&&previousXSDURI!=null){
                        if(!includedSchema.getDocumentBaseURI().equals(previousXSDURI)){
                            Node n1=getNodeOfType_ITERATIVE(nameOfNode,includedSchema,importedOrIncludedSchema.getDocumentBaseURI(), theSchemaOfTheWSDL);
                    ...
                    else if(includedSchema.getDocumentBaseURI()!=null&&importedOrIncludedSchema.getDocumentBaseURI()!=null){
                        Node n1=getNodeOfType_ITERATIVE(nameOfNode,includedSchema,importedOrIncludedSchema.getDocumentBaseURI(),theSchemaOfTheWSDL);
                        if(n1!=null)return n1;   
                    }   
                    ...
                    try{
                        ...
                        if(importedSchema.getDocumentBaseURI()!=null&&previousXSDURI!=null){
                            if(!importedSchema.getDocumentBaseURI().equals(previousXSDURI)){
                                Node n1=getNodeOfType_ITERATIVE(nameOfNode,importedSchema,importedOrIncludedSchema.getDocumentBaseURI(),theSchemaOfTheWSDL);
                                if(n1!=null)return n1;                            
                            }else{
                                                //-System.out.println("AAAAAAAAAAAAAAAAAAA!~!!!!!!!!!!!!!!!!");
                                            }
                        }else if(importedSchema.getDocumentBaseURI()!=null&&importedOrIncludedSchema.getDocumentBaseURI()!=null){
                            Node n1=getNodeOfType_ITERATIVE(nameOfNode,importedSchema,importedOrIncludedSchema.getDocumentBaseURI(),theSchemaOfTheWSDL);
                            if(n1!=null)return n1;   
                        }
                            ...
                            while(importsIter.hasNext()){                            
                                ...
                                if(schImpls.size()>0){
                                    for(int i=0;i<schImpls.size();i++){
                                        ...
                                        if(importedSchema.getDocumentBaseURI()!=null&&previousXSDURI!=null){
                                            if(!importedSchema.getDocumentBaseURI().equals(previousXSDURI)){
                                                Node n1=getNodeOfType_ITERATIVE(nameOfNode,importedSchema,importedOrIncludedSchema.getDocumentBaseURI(),
                                                        theSchemaOfTheWSDL);
                                                if(n1!=null)return n1;                            
                                            }else{
                                                //-System.out.println("AAAAAAAAAAAAAAAAAAA!~!!!!!!!!!!!!!!!!");
    ...
    public static Node getNodeOfType(String nameOfNode, javax.wsdl.extensions.schema.Schema theSchemaOfTheWSDL,
        ...
        //previousXSDURI used gia na glitwsw stackOverFlow an to ena XSD kanei import ena allo pou kanei import to "ena"
        URIsAlreadyParsed=new HashMap();
        if(nameOfNode.equals("gmd:PT_FreeText_PropertyType")){
            //-System.out.println("AAA1");
        }
        Node res=null;
        //-System.out.println("### ### Looking for Node:  "+nameOfNode +"  in: "+theSchemaOfTheWSDL.getDocumentBaseURI());
        //-System.out.println("############# Previous XSD URI:"+previousXSDURI);
        if(nameOfNode==null||theSchemaOfTheWSDL==null)return null;
        ...
        if(theNodeNamespaceKey!=null){
            ...
            if(theNodeNamespace!=null){
                Schema nsSchema1=getTheImportedOrIncludedSchemaWithTheSpecificNS(theSchemaOfTheWSDL, theNodeNamespace);
                if(nsSchema1!=null){
                    nsSchema=nsSchema1;
                }
                else {
        ...
        }else nsSchema=theSchemaOfTheWSDL;
        ...
        if(nsSchema!=null){                      
            ...
            if(includesList!=null){
                ...
                while(includesIter.hasNext()){
                    ...
                    if(includedSchema.getDocumentBaseURI()!=null&&previousXSDURI!=null){
                        if(!includedSchema.getDocumentBaseURI().equals(previousXSDURI)){
                            Node n1=getNodeOfType_ITERATIVE(nameOfNode,includedSchema,theSchemaOfTheWSDL.getDocumentBaseURI(), theSchemaOfTheWSDL);
                            if(n1!=null)return n1;                            
                        }else{
                                                //-System.out.println("AAAAAAAAAAAAAAAAAAA!~!!!!!!!!!!!!!!!!");
                                            }
                    ...
                    else if(includedSchema.getDocumentBaseURI()!=null&&theSchemaOfTheWSDL.getDocumentBaseURI()!=null){
                        Node n1=getNodeOfType_ITERATIVE(nameOfNode,includedSchema,theSchemaOfTheWSDL.getDocumentBaseURI(),theSchemaOfTheWSDL);
                        if(n1!=null)return n1;   
                    }   
                    //Node n1=getNodeOfType(nameOfNode,includedSchema,null);
            ...
            if(importsMap!=null){
                ...
                while(importsIter.hasNext()){
                    try{
                        ...
                        if(importedSchema.getDocumentBaseURI()!=null&&previousXSDURI!=null){
                            if(!importedSchema.getDocumentBaseURI().equals(previousXSDURI)){
                                Node n1=getNodeOfType_ITERATIVE(nameOfNode,importedSchema,theSchemaOfTheWSDL.getDocumentBaseURI(),theSchemaOfTheWSDL);
                                if(n1!=null)return n1;                            
                            }else{
                                                //-System.out.println("AAAAAAAAAAAAAAAAAAA!~!!!!!!!!!!!!!!!!");
                                            }
                        }else if(importedSchema.getDocumentBaseURI()!=null&&theSchemaOfTheWSDL.getDocumentBaseURI()!=null){
                            Node n1=getNodeOfType_ITERATIVE(nameOfNode,importedSchema,theSchemaOfTheWSDL.getDocumentBaseURI(),theSchemaOfTheWSDL);
                            if(n1!=null)return n1;   
                        }
                            ...
                            while(importsIter.hasNext()){                            
                                ...
                                if(schImpls.size()>0){
                                    for(int i=0;i<schImpls.size();i++){
                                        ...
                                        if(importedSchema.getDocumentBaseURI()!=null&&previousXSDURI!=null){
                                            if(!importedSchema.getDocumentBaseURI().equals(previousXSDURI)){
                                                Node n1=getNodeOfType_ITERATIVE(nameOfNode,importedSchema,theSchemaOfTheWSDL.getDocumentBaseURI(),
                                                        theSchemaOfTheWSDL);
                                                if(n1!=null)return n1;                            
                                            }else{
                                                //-System.out.println("AAAAAAAAAAAAAAAAAAA!~!!!!!!!!!!!!!!!!");
    ...
    public static javax.wsdl.extensions.schema.Schema getTheImportedOrIncludedSchemaWithTheSpecificNS(javax.wsdl.extensions.schema.Schema theSchemaOfTheWSDL, 
            String xsdNamespaceURI){
        
        if(theSchemaOfTheWSDL==null)return null;
        ...
        while (importsItt.hasNext()) {
            ...
            while (importsItt2.hasNext()) {
                ...
                if(schemaImportInitial.getNamespaceURI()!=null&&schemaImportInitial.getNamespaceURI().equals(xsdNamespaceURI)){
                        ...
                        if(extElementsList!=null){
                            ...
                            while(iter1.hasNext()){
                                try{
                                    ...
                                    if(theWSDLxsdSchema.getElement().getAttribute("targetNamespace").equals(xsdNamespaceURI)){
               ...
               //                 ////-System.out.println(schemaImportInitial.getNamespaceURI());
                ...
                if(schemaImport!=null&&schemaImport.getNamespaceURI()!=null&&schemaImport.getNamespaceURI().equals(xsdNamespaceURI)){
                    javax.wsdl.extensions.schema.Schema importedSchema = schemaImport.getReferencedSchema();   

...
public class Activator implements BundleActivator {
	...
	public void start(BundleContext bcontext) throws Exception {
		...
		if (crypt)
			CryptUtil.init(Configuration.getGCMCrypt());
		...
		// Instance persistence DB once API impl is ready and before it is
		// public in servlet
		try {
		...
		if (hard) {
			...
			// TODO If there are more than 1 HttpService, it gets registered in
			// all !

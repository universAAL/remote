...
public class NativeObject {
    ...
    public NativeObject cloneTheNO() {
        ...
        no.setObjectName(new QName(this.objectName.getNamespaceURI(), this.getObjectName().getLocalPart(), this.getObjectName().getPrefix()));

        if (this.objectType == null) {
            no.setObjectType(new QName(this.objectName.getNamespaceURI(), this.getObjectName().getLocalPart(), this.getObjectName().getPrefix()));
        } else {
            no.setObjectType(new QName(this.objectType.getNamespaceURI(), this.getObjectType().getLocalPart(), this.getObjectType().getPrefix()));
        }
        //no.setObjectType(new QName(this.objectType.getNamespaceURI(),this.getObjectType().getLocalPart(),this.getObjectType().getPrefix()));

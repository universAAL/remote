...
public class GatewayPortTestImpl extends GatewayPort {
	...
	// has happened if the request's reader is closed
	// }
	//
	// return sb.toString();
	// }
	...
	public void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		// String[] userAndPass =
		// getUserAndPass(req.getHeader("Authorization"));
		...
		html.append(
				"HTTP/1.1 200 OK Cache-Control: no-store, no-cache, must-revalidate Content-Type: text/html;charset=ISO-8859-1 Transfer-Encoding: chunked Server: Jetty(7.x.y-SNAPSHOT) <html>    <head>    <title>Some title     </title></head><body ></body></html>");
